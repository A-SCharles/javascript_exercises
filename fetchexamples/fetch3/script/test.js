...
function getNewUser() {
  ...
  document.body.classList.contains("lego") && (t = "&lego"),
    pegasus("https://randomuser.me/api/?nat=us&randomapi" + t).then(function (
      t
    ) {
      if (!t.error) {
        var i = t.results[0];
        (document
          ...
          .getElementsByTagName("img")[0].src = i.picture.large),
        ...
        e(
          "birthday",
          n.getMonth() + 1 + "/" + (n.getDay() + 1) + "/19" + n.getYear()
        ),
          e(
            "location",
...
!(function (t, e) {
  ...
  (function () {
    if (-1 !== document.title.indexOf("home")) {
      pegasus("https://randomuser.me/api/?randomapi").then(
        function (e) {
          t(e);
        },
        function (e) {
      ...
      var t = function (t) {
        if (t.error) {
          ...
          (e.className = "alert"),
            (e.innerHTML =
              'API Status: OFFLINE. Please tweet us <a href="https://twitter.com/randomapi">@randomapi</a> if you are seeing this message.');
  ...
  domready(function () {
    -1 !== window.location.href.indexOf("stats") &&
      pegasus("getStats").then(function (t) {
        ...
        Highcharts.setOptions({ lang: { thousandsSep: "," } }),
          new Highcharts.Chart({
            ...
            yAxis: [
              ...
              {
                labels: { format: "{value} MB", style: { color: "#FF7148" } },
                title: { text: "Bandwidth" },
              },
            ],
            series: [
              { name: "Bandwidth", yAxis: 1, color: "#FF7148", data: n },
              { name: "Users", data: i, color: "#93B1C6" },
            ],
            tooltip: { shared: !0 },
          });
      });
  ...
  domready(function () {
    if (-1 !== document.title.indexOf("Home")) {
      ...
      var t = Array.prototype.slice.call(
        document.getElementById("values_list").getElementsByTagName("li")
      );
      t.forEach(function (e) {
        e.addEventListener("mouseover", function () {
          t.forEach(function (t) {
            ...
            this.getAttribute("data-caps")
              ? (document.getElementById("user_value").style.textTransform =
                  "lowercase")
              : (document.getElementById("user_value").style.textTransform =
                  "capitalize");
        });
  ...
  (function (t, e) {
    "object" == typeof module && module.exports
      ? (module.exports = t.document ? e(t) : e)
      : (t.Highcharts = e(t));
    ...
    function n() {
      ...
      for (
        !0 === i[0] && ((n = i[1]), (i = Array.prototype.slice.call(i, 2))),
          e = i.length,
          t = 0;
        t < e;
        t++
    ...
    function d(t, e, i) {
      ...
      if (o(e))
        p(i)
          ? t.setAttribute(e, i)
          : t && t.getAttribute && (r = t.getAttribute(e));
      else if (p(e) && s(e)) for (n in e) t.setAttribute(n, e[n]);
      return r;
    }
    function f(t) {
      return a(t) ? t : [t];
    ...
    function y(t, e, i, n, r) {
      return (
        (t = $.createElement(t)),
        e && Rt(t, e),
        r && m(t, { padding: 0, border: "none", margin: 0 }),
        i && m(t, i),
        n && n.appendChild(t),
        t
      );
    ...
    function b(t, e) {
      for (
        var i, n, r, o, s, a = "{", h = !1, c = [];
        -1 !== (a = t.indexOf(a));

      ) {
        if (((i = t.slice(0, a)), h)) {
          for (
            s = (r = (n = i.split(":")).shift().split(".")).length,
              i = e,
              o = 0;
            o < s;
            o++
              ...
              ? ((s = (s = n.match(r)) ? s[1] : -1),
                null !== i &&
                  (i = V.numberFormat(
                    ...
                    s,
                    o.decimalPoint,
                    -1 < n.indexOf(",") ? o.thousandsSep : ""
                  )))
              : (i = R(n, i)));
        }
        c.push(i), (t = t.slice(a + 1)), (a = (h = !h) ? "}" : "{");
      }
    ...
    function A(t, e) {
      for (var i in t)
        t[i] && t[i] !== e && t[i].destroy && t[i].destroy(), delete t[i];
    }
    function T(t) {
      O || (O = y("div")), t && O.appendChild(t), (O.innerHTML = "");
    }
    function S(t, e) {
    ...
    var M,
      ...
      ot = Z.PI,
      st = (2 * ot) / 360,
      at = (t.navigator && t.navigator.userAgent) || "",
      ht = t.opera,
      ct = /(msie|trident|edge)/i.test(at) && !ht,
      lt = !ct && /AppleWebKit/.test(at),
      ut = /Firefox/.test(at),
      pt = /(Mobile|Android|Windows Phone)/.test(at),
      dt =
        $ &&
        $.createElementNS &&
        !!$.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
      ft = ut && 4 > parseInt(at.split("Firefox/")[1], 10),
      gt = $ && !dt && !ct && !!$.createElement("canvas").getContext,
      mt = {},
      yt = 0,
      vt = [],
      xt = 0,
      bt = /^[0-9]+$/,
      wt = ["plotTop", "marginRight", "marginBottom", "plotLeft"],
      kt = {};
    (V = t.Highcharts ? e(16, !0) : { win: t }).seriesTypes = kt;
    var Ct,
      At,
      Tt,
      St,
        ...
        (this.startTime = +new D()),
          ...
          o() &&
            ...
            (o.timerId = setInterval(function () {
              for (n = 0; n < It.length; n++) It[n]() || It.splice(n--, 1);
      ...
      initPath: function (t, e, i) {
        ...
        var a = t.isArea,
          ...
          c = function (t) {
            for (n = t.length; n--; )
              ("M" !== t[n] && "L" !== t[n]) ||
                t.splice(n + 1, 0, t[n + 1], t[n + 2], t[n + 1], t[n + 2]);
          };
        if ((o && (c(e), c(i)), r <= i.length / s && e.length === i.length))
          for (; r--; )
    ...
    var Rt = (V.extend = function (t, e) {
      ...
      Nt = (V.pick = function () {
        var t,
          ...
          i = arguments,
          n = i.length;
        for (t = 0; t < n; t++) if ((e = i[t]) !== M && null !== e) return e;
      }),
    ...
    (R = function (t, e, i) {
      if (!p(e) || isNaN(e)) return I.lang.invalidDate || "";
      t = Nt(t, "%Y-%m-%d %H:%M:%S");
      var n,
        r = (u = new D(e - 6e4 * ((H && H(e)) || z || 0)))[W](),
        o = u[X](),
        s = u[_](),
        a = u[G](),
        h = u[Y](),
      ...
      (V.numberFormat = function (t, e, i, n) {
        ...
        var o,
          ...
          c = Math.abs(t);
        return (
          -1 === e ? (e = Math.min(h, 20)) : isNaN(e) && (e = 2),
          ...
          +e &&
            (t +=
              i +
              (n = Math.abs(c - o + Math.pow(10, -Math.max(e, h) - 1)))
                .toFixed(e)
                .slice(2)),
          t
        );
      ...
      (Ct = function (e, i) {
        ...
        return "width" === i
          ...
          ? Math.min(e.offsetHeight, e.scrollHeight) -
            Ct(e, "padding-top") -
            Ct(e, "padding-bottom")
          : (n = t.getComputedStyle(e, void 0)) && r(n.getPropertyValue(i));
      }),
      (At = function (t, e) {
      ...
      (Pt = function (e) {
        ...
        return {
          top:
            ...
            (t.pageYOffset || i.scrollTop) -
            (i.clientTop || 0),
          left: e.left + (t.pageXOffset || i.scrollLeft) - (i.clientLeft || 0),
        };
      }),
      (Ot = function (t) {
        for (var e = It.length; e--; ) It[e].elem === t && (It[e].stopped = !0);
      }),
      (Tt = function (t, e) {
      ...
      (Lt = function (t, e, i) {
        function n(e, i) {
          t.removeEventListener
            ...
            : t.attachEvent &&
              ((i = t.hcEventsIE[i.toString()]), t.detachEvent("on" + e, i));
        }
        function r() {
          var i, r;
          if (t.nodeName)
            for (r in (e ? ((i = {})[e] = !0) : (i = a), i))
              if (a[r]) for (i = a[r].length; i--; ) n(r, a[r][i]);
        }
        var o,
          s,
          a = t.hcEvents;
        a &&
          (e
            ? ((o = a[e] || []),
              i
                ? (-1 < (s = At(i, o)) && (o.splice(s, 1), (a[e] = o)), n(e, i))
                : (r(), (a[e] = [])))
            : (r(), (t.hcEvents = {})));
      }),
      (Mt = function (t, e, i, n) {
      ...
      (Ft = function (t, e, r) {
        var o,
          ...
          u = "";
        for (l in (s(r) ||
          (r = { duration: (o = arguments)[2], easing: o[3], complete: o[4] }),
        ...
        e))
          (c = new i(t, r, l)),
            (a = null),
            "d" === l
              ? ((c.paths = c.initPath(t, t.d, e.d)),
                (c.toD = e.d),
                (o = 0),
                (a = 1))
              : t.attr
              ? (o = t.attr(l))
              : ((o = parseFloat(Ct(t, l)) || 0),
                "opacity" !== l && (u = "px")),
            a || (a = e[l]),
      ...
      t.jQuery &&
        (t.jQuery.fn.highcharts = function () {
          ...
          if (this[0])
            return t[0]
              ? (new V[o(t[0]) ? t.shift() : "Chart"](this[0], t[0], t[1]),
                this)
              : vt[d(this[0], "data-highcharts-chart")];
        }),
      $ &&
        !$.defaultView &&
        (Ct = function (t, e) {
          var i;
          return (
            (i = { width: "clientWidth", height: "clientHeight" }[e]),
            t.style[e]
              ? r(t.style[e])
              : ("opacity" === e && (e = "filter"),
                i
                  ? ((t.style.zoom = 1), t[i] - 2 * Ct(t, "padding"))
                  : ((i =
                      t.currentStyle[
    ...
    var zt = (I = {
      ...
      global: {
        useUTC: !0,
        canvasToolsURL:
          "http://code.highcharts.com@product.cdnpath@//Highstock 4.2.3/modules/canvas-tools.js",
        VMLRadialGradientURL:
          "http://code.highcharts.com@product.cdnpath@//Highstock 4.2.3/gfx/vml-radial-gradient.png",
      },
      chart: {
        borderColor: "#4572A7",
        borderRadius: 0,
    ...
    P(),
      ...
      (B.prototype = {
        ...
        animate: function (t, e, i) {
          return (
            (e = Nt(e, this.renderer.globalAnimation, !0)),
            Ot(this),
            e
              ? ((e = n(e, {})), i && (e.complete = i), Ft(this, t, e))
              : this.attr(t, null, i),
            this
          );
        },
        colorGradient: function (t, e, i) {
          ...
          if (
            (t.linearGradient
              ? (o = "linearGradient")
              : t.radialGradient && (o = "radialGradient"),
            o)
          ) {
            for (m in ((s = t[o]),
            (c = v.gradients),
            ...
            c[(x = x.join(","))]
              ? (g = c[x].attr("id"))
              : ((s.id = g = "highcharts-" + yt++),
                (c[x] = l = v.createElement(o).attr(s).add(v.defs)),
                (l.radAttr = h),
                (l.stops = []),
                Tt(u, function (t) {
                  0 === t[1].indexOf("rgba")
                    ? ((r = E(t[1])), (d = r.get("rgb")), (f = r.get("a")))
                    : ((d = t[1]), (f = 1)),
                    (t = v
                      .createElement("stop")
                      .attr({
        ...
        applyTextShadow: function (t) {
          var e,
            ...
            a = s || (i.style.textShadow !== M && !ct);
          n &&
            (o.textShadow = t =
              t.replace(/contrast/g, this.renderer.getContrast(i.style.fill))),
                  ...
                  (t = t.split(" ")),
                    ...
                    (o = t[t.length - 2]) &&
                      Tt(e, function (t, e) {
                        var a;
                        0 === e &&
                          (t.setAttribute("x", i.getAttribute("x")),
                          (e = i.getAttribute("y")),
            ...
            for (n in t)
              (e = t[n]),
                ...
                this.symbolName &&
                  ...
                  (r || (this.symbolAttr(t), (r = !0)), (o = !0)),
                !this.rotation ||
                  ("x" !== n && "y" !== n) ||
                  (this.doTransform = !0),
                o ||
                  ((o = this[n + "Setter"] || this._defaultSetter).call(
                    this,
                    e,
                    n,
                    s
        ...
        css: function (t) {
          var e,
            ...
            s = this.element,
            a = "";
          if (((e = !n), t && t.color && (t.fill = t.color), n))
            for (i in t) t[i] !== n[i] && ((o[i] = t[i]), (e = !0));
          if (e) {
            if (
              ((e = this.textWidth =
                (t &&
            ...
            F && "click" === t
              ? ((n.ontouchstart = function (t) {
                ...
                (n.onclick = function (t) {
                  (-1 === at.indexOf("Android") ||
                    1100 < D.now() - (i.touchEventFired || 0)) &&
                    e.call(n, t);
                }))
              : (n["on" + t] = e),
            this
        ...
        align: function (t, e, i) {
          var n,
            ...
            h = {};
          return (
            (s = (r = this.renderer).alignedObjects),
            t
              ? ((this.alignOptions = t),
                (this.alignByTranslate = e),
                (!i || o(i)) &&
                  ((this.alignTo = n = i || "renderer"),
                  u(s, this),
                  s.push(this),
                  (i = null)))
              : ((t = this.alignOptions),
            ...
            (a = (i.y || 0) + (t.y || 0)),
            ("right" !== n && "center" !== n) ||
              (s += (i.width - (t.width || 0)) / { right: 1, center: 2 }[n]),
            (h[e ? "translateX" : "x"] = K(s)),
            ("bottom" !== r && "middle" !== r) ||
              (a +=
                (i.height - (t.height || 0)) /
                ({ bottom: 1, middle: 2 }[r] || 1)),
        ...
        getBBox: function (t, e) {
          ...
          var c,
            ...
            f = s.cacheKeys;
          if (
            ((o = (r = Nt(e, this.rotation)) * st),
            n !== M &&
              ((u = ["", r || 0, h && h.fontSize, a.style.width].join()),
              (u =
                "" === n || bt.test(n)
                  ? "num:" + n.toString().length + u
                  : n + u)),
            u && !t && (i = d[u]),
            !i)
          ) {
            if (
              ...
              try {
                (l =
                  ...
                  function (t) {
                    Tt(
                      a.querySelectorAll(".highcharts-text-shadow"),
                      function (e) {
                        e.style.display = t;
                      }
                    );
            ...
            if (
              (s.isSVG &&
                ...
                ct &&
                  h &&
                  "11px" === h.fontSize &&
                  "16.9" === n.toPrecision(3) &&
                  (i.height = n = 14),
                r &&
                  ((i.width = it(n * rt(o)) + it(s * nt(o))),
                  (i.height = it(n * nt(o)) + it(s * rt(o))))),
              u)
            ) {
              for (; 250 < f.length; ) delete d[f.shift()];
              d[u] || f.push(u), (d[u] = i);
            }
          }
          return i;
        ...
        destroy: function () {
          ...
          for (
            ...
            (n = o.parentGroup),
              ...
              delete o.div,
              (o = n);
          for (t in (i.alignTo && u(i.renderer.alignedObjects, i), i))
            delete i[t];
          return null;
        },
        ...
        titleSetter: function (t) {
          ...
          e ||
            ((e = $.createElementNS("http://www.w3.org/2000/svg", "title")),
            this.element.appendChild(e)),
            e.appendChild(
              $.createTextNode(String(Nt(t), "").replace(/<[^>]*>/g, ""))
            );
        },
        ...
        zIndexSetter: function (t, e) {
          var i,
            ...
            a = this.renderer,
            h = this.parentGroup,
            c = ((a = (h || a).element || a.box), this.element);
          if (
            ((i = this.added),
            p(t) &&
              (c.setAttribute(e, t),
          ...
          (this[e] = t),
            this.stroke && this["stroke-width"]
              ...
              : "stroke-width" === e &&
                0 === t &&
                this.hasStroke &&
                (i.removeAttribute("stroke"), (this.hasStroke = !1));
        });
    var Ht = function () {
    ...
    (Ht.prototype = {
      ...
      init: function (e, i, n, r, o, s) {
        var a, h;
        (a = (r = this.createElement("svg")
          .attr({ version: "1.1" })
          .css(this.getStyle(r))).element),
          e.appendChild(a),
          -1 === e.innerHTML.indexOf("xmlns") &&
          ...
          (this.alignedObjects = []),
          (this.url =
            (ut || lt) && $.getElementsByTagName("base").length
              ? t.location.href
                  .replace(/#.*?$/, "")
                  .replace(/([\('\)])/g, "\\$1")
                  .replace(/ /g, "%20")
          ...
          this.createElement("desc")
            .add()
            .element.appendChild(
              $.createTextNode("Created with Highcharts 4.2.3 /Highstock 4.2.3")
            ),
      ...
      buildText: function (t) {
        for (
          var e,
            ...
            f = u && u.lineHeight,
            g = u && u.textShadow,
            y = u && "ellipsis" === u.textOverflow,
            v = c.length,
            x = p && !t.added && this.box,
            b = function (t) {
              return f
                ? r(f)
                : o.fontMetrics(
                    /(px|em)$/.test(t && t.style.fontSize)
                      ? t.style.fontSize
                      : (u && u.fontSize) || o.style.fontSize || 12,
                    t
                  ).h;
            };
          v--;
        ...
        h || g || y || -1 !== a.indexOf(" ")
          ? ((e = /<.*style="([^"]+)".*>/),
                ...
                Tt(h, function (r) {
                  if ("" !== r || 1 === h.length) {
                    ...
                    if (
                      ...
                      if (
                        (v.appendChild($.createTextNode(r)),
                        c ? (g.dx = 0) : a && null !== l && (g.x = l),
                        d(v, g),
                        n.appendChild(v),
                        !c &&
                          a &&
                          (!dt && s && m(v, { display: "block" }),
                          d(v, "dy", b(v))),
                        p)
                      ) {
                        ...
                        for (
                          var x,
                            ...
                            C =
                              1 < h.length ||
                              a ||
                              (1 < g.length && "nowrap" !== u.whiteSpace),
                            A = [],
                            T = b(v),
                            S = t.rotation,
                            P = r,
                            E = P.length;
                          (C || y) && (g.length || A.length);
                        ...
                        w && t.attr("title", t.textStr), (t.rotation = S);
                      }
                      c++;
                    }
                  }
            ...
            x && x.removeChild(n),
            g && t.applyTextShadow && t.applyTextShadow(g))
          : n.appendChild(
              $.createTextNode(a.replace(/&lt;/g, "<").replace(/&gt;/g, ">"))
            );
      },
      ...
      button: function (t, e, i, r, o, s, a, h, c) {
        var l,
          ...
          f,
          g,
          m = this.label(t, e, i, c, null, null, null, null, "button"),
          y = 0;
        return (
          (o = n(
            {
              ...
              stroke: "#CCCCCC",
              fill: {
                linearGradient: (t = { x1: 0, y1: 0, x2: 0, y2: 1 }),
                stops: [
                  [0, "#FEFEFE"],
                  [1, "#F6F6F6"],
                ],
          ...
          Bt(m.element, ct ? "mouseout" : "mouseleave", function () {
            3 !== y &&
              ((l = [o, s, a][y]), (u = [p, d, f][y]), m.attr(l).css(u));
          }),
          ...
          m
            ...
            .attr(o)
            .css(Rt({ cursor: "default" }, p))
        );
      },
      crispLine: function (t, e) {
        return (
          t[1] === t[4] && (t[1] = t[4] = K(t[1]) - (e % 2) / 2),
      ...
      rect: function (t, e, i, n, r, o) {
        ...
        return (
          (t = s(t)
            ...
            : t === M
            ? {}
            : { x: t, y: e, width: tt(i, 0), height: tt(n, 0) }),
          o !== M && ((a.strokeWidth = o), (t = a.crisp(t))),
          r && (t.r = r),
      ...
      g: function (t) {
        ...
        return p(t) ? e.attr({ class: "highcharts-" + t }) : e;
      },
      image: function (t, e, i, n, r) {
        var o = { preserveAspectRatio: "none" };
        return (
          1 < arguments.length && Rt(o, { x: e, y: i, width: n, height: r }),
          (o = this.createElement("image").attr(o)).element.setAttributeNS
            ? o.element.setAttributeNS(
                "http://www.w3.org/1999/xlink",
                "href",
                t
              )
            : o.element.setAttribute("hc-svg-href", t),
          o
        );
      },
      symbol: function (t, e, i, n, r, o) {
        var s,
          ...
          u = /^url\((.*?)\)$/;
        return (
          (a = (a = this.symbols[t]) && a(K(e), K(i), n, r, o))
            ? ((s = this.path(a)),
              Rt(s, { symbolName: t, x: e, y: i, width: n, height: r }),
              o && Rt(s, o))
            : u.test(t) &&
              ((c = function (t, e) {
                t.element &&
                  (t.attr({ width: e[0], height: e[1] }),
                  t.alignByTranslate ||
                    t.translate(K((n - e[0]) / 2), K((r - e[1]) / 2)));
              }),
              (h = t.match(u)[1]),
              (t = mt[h] || (o && o.width && o.height && [o.width, o.height])),
              ((s = this.image(h).attr({ x: e, y: i })).isImg = !0),
              t
                ? c(s, t)
        ...
        callout: function (t, e, i, n, r) {
          ...
          return (
            ...
            h && h > i && r > e + a && r < e + n - a
              ...
              : h && 0 > h && r > e + a && r < e + n - a
              ? o.splice(33, 3, "L", t, r + 6, t - 6, r, t, r - 6, t, e + s)
              : r && r > n && h > t + a && h < t + i - a
              ? o.splice(
                  23,
                  3,
              ...
              : r &&
                ...
                h > t + a &&
                h < t + i - a &&
                o.splice(3, 3, "L", h - 6, e, h, e - 6, h + 6, e, i - s, e),
            o
          );
        },
      },
      clipRect: function (t, e, i, n) {
        var r = "highcharts-" + yt++,
          o = this.createElement("clipPath").attr({ id: r }).add(this.defs);
        return (
          ((t = this.rect(t, e, i, n, 0).add(o)).id = r),
          (t.clipPath = o),
          (t.count = 0),
          t
        );
      ...
      fontMetrics: function (e, i) {
        ...
        return (
            ...
            (e = (n = t.getComputedStyle(i, "")) && n.fontSize)),
          {
            h: (n =
              24 >
              (e = /px/.test(e) ? r(e) : /em/.test(e) ? 12 * parseFloat(e) : 12)
                ? e + 3
                : K(1.2 * e)),
            b: K(0.8 * n),
            f: e,
      ...
      label: function (t, e, i, r, o, s, a, h, c) {
        ...
        (x = function () {
          ...
          (t = A.element.style),
            (u =
              (void 0 === d || void 0 === f || C.styles.textAlign) &&
              p(A.textStr) &&
              A.getBBox()),
            ...
            v &&
              (l ||
                ...
                (C.box = l =
                  r
                    ? k.symbol(r, t, e, C.width, C.height, L)
                    : k.rect(t, e, C.width, C.height, 0, L["stroke-width"])),
                l.isImg || l.attr("fill", "none"),
                l.add(C)),
              l.isImg ||
                l.attr(Rt({ width: K(C.width), height: K(C.height) }, L)),
              (L = null));
        }),
          (b = function () {
            var t,
              e = (e = C.styles) && e.textAlign,
              i = P + S;
            (t = h ? 0 : y),
              p(d) &&
                u &&
                ("center" === e || "right" === e) &&
                (i += { center: 0.5, right: 1 }[e] * (d - u.width)),
              (i === A.x && t === A.y) ||
                (A.attr("x", i), t !== M && A.attr("y", t)),
              (A.x = i),
              (A.y = t);
          }),
          (w = function (t, e) {
          ...
          (C.onAdd = function () {
            A.add(C),
              C.attr({ text: t || 0 === t ? t : "", x: e, y: i }),
              l && p(o) && C.attr({ anchorX: o, anchorY: s });
          }),
      ...
      (L.prototype = {
        addLabel: function () {
          var t,
            ...
            a = this.pos,
            h = i.labels,
            c = a === (d = e.tickPositions)[0],
            u = a === d[d.length - 1],
            d = ((s = o ? Nt(o[a], s[a], a) : a), (o = this.label), d.info);
          e.isDatetimeAxis &&
            d &&
            (t = i.dateTimeLabelFormats[d.higherRanks[a] || d.unitName]),
            (this.isFirst = c),
            (this.isLast = u),
            ...
            p(o)
              ...
              : ((this.labelLength =
                  (this.label = o =
                    p(i) && h.enabled
                      ? r.renderer
                          .text(i, 0, 0, h.useHTML)
                          .css(n(h.style))
                          .add(e.labelGroup)
                      : null) && o.getBBox().width),
                (this.rotation = 0));
        },
        ...
        handleOverflow: function (t) {
          var e,
            ...
            o = i.chart.spacing,
            s = Nt(i.labelLeft, et(i.pos, o[3])),
            a =
              ((o = Nt(i.labelRight, tt(i.pos + i.len, r - o[1]))), this.label),
            h = this.rotation,
            c = { left: 0, center: 0.5, right: 1 }[i.labelAlign],
            l = a.getBBox().width,
            u = i.slotWidth,
            p = 1,
            d = {};
          h
            ? 0 > h && n - c * l < s
              ? (e = K(n / nt(h * st) - s))
              : 0 < h && n + c * l > o && (e = K((r - n) / nt(h * st)))
            : ((r = n + (1 - c) * l),
              n - c * l < s
                ? (u = t.x + u * (1 - c) - s)
                : r > o && ((u = o - t.x + u * c), (p = -1)),
              (u = et(i.slotWidth, u)) < i.slotWidth &&
                "center" === i.labelAlign &&
                (t.x += p * (i.slotWidth - u - c * (i.slotWidth - et(l, u)))),
              (l > u || (i.autoRotation && a.styles.width)) && (e = u)),
            e &&
              ((d.width = e),
              i.options.labels.style.textOverflow ||
        ...
        getPosition: function (t, e, i, n) {
          ...
          return {
            x: t
              ? r.translate(e + i, null, null, n) + r.transB
              : r.left +
                r.offset +
                (r.opposite
                  ? ((n && o.oldChartWidth) || o.chartWidth) - r.right - r.left
                  : 0),
            y: t
              ? s - r.bottom + r.offset - (r.opposite ? r.height : 0)
              : s - r.translate(e + i, null, null, n) - r.transB,
          };
        },
        ...
        render: function (t, e, i) {
          ...
          (i = Nt(i, 1)),
            (this.isActive = !0),
            d &&
              ((c = n.getPlotLinePath(c + k, d * T, e, !0)),
              u === M &&
                ((u = { stroke: f, "stroke-width": d }),
                g && (u.dashstyle = g),
                a || (u.zIndex = 1),
                e && (u.opacity = 0),
                (this.gridLine = u =
                  d ? o.path(c).attr(u).add(n.gridGroup) : null)),
              !e && u && c) &&
              u[this.isNew ? "attr" : "animate"]({ d: c, opacity: i }),
            y &&
              m &&
              ("inside" === x && (m = -m),
              n.opposite && (m = -m),
              ...
              p
                ? p.animate({ d: a, opacity: i })
                : (this.mark = o
                    .path(a)
                    .attr({ stroke: v, "stroke-width": y, opacity: i })
                    .add(n.axisGroup))),
            h &&
              !isNaN(C) &&
              ((h.xy = A = this.getLabelPosition(C, A, h, s, l, k, t, b)),
              (this.isFirst && !this.isLast && !Nt(r.showFirstLabel, 1)) ||
              (this.isLast && !this.isFirst && !Nt(r.showLastLabel, 1))
                ? (w = !1)
                : !s ||
                  n.isRadial ||
                  l.step ||
      ...
      (V.PlotLineOrBand.prototype = {
        render: function () {
          var t,
            ...
            w = {},
            k = i.chart.renderer;
          if ((i.isLog && ((u = c(u)), (l = c(l)), (f = c(f))), h))
            (y = i.getPlotLinePath(f, h)),
              (w = { stroke: v, "stroke-width": h }),
              g && (w.dashstyle = g);
          else {
            if (!d) return;
            (y = i.getPlotBandPath(u, l, o)),
              v && (w.fill = v),
              o.borderWidth &&
                ((w.stroke = o.borderColor),
                (w["stroke-width"] = o.borderWidth));
          }
          if (((w.zIndex = x), m))
            y
              ? (m.show(), m.animate({ d: y }))
              : (m.hide(), a && (e.label = a = a.destroy()));
          else if (
            y &&
            y.length &&
            ((e.svgElem = m = k.path(y).attr(w).add()), b)
          )
        ...
        renderLabel: function (t, e, i, n) {
          ...
          r ||
            ...
            (this.label = r =
              o.text(t.text, 0, 0, t.useHTML).attr(r).css(t.style).add())),
            (n = [e[1], e[4], i ? e[6] : e[1]]),
            (e = [e[2], e[5], i ? e[7] : e[2]]),
            (i = k(n)),
            (o = k(e)),
            r.align(t, !1, { x: i, y: o, width: C(n) - i, height: C(e) - o }),
            r.show();
        },
        destroy: function () {
    ...
    (jt.prototype = {
      ...
      defaultYAxisOptions: {
        ...
        stackLabels: {
          ...
          style: n(zt.line.dataLabels.style, { color: "#000000" }),
        },
      },
      ...
      init: function (t, e) {
        ...
        (this.labelFormatter =
          o.labels.formatter || this.defaultLabelFormatter),
          (this.userOptions = e),
          ...
          (this.crosshair = Nt(
            o.crosshair,
            f(t.options.tooltip.crosshairs)[i ? 0 : 1],
            !1
          ));
        var r,
          o = this.options.events;
        for (r in (-1 === At(this, t.axes) &&
          (i && !this.isColorAxis
        ...
        o))
          Bt(this, r, o[r]);
        this.isLog && ((this.val2lin = c), (this.lin2val = l));
      },
      ...
      defaultLabelFormatter: function () {
        ...
        if (a) t = b(a, this);
          ...
          for (; s-- && t === M; )
            e >= (n = Math.pow(1e3, s + 1)) &&
              0 == (10 * i) % n &&
              null !== o[s] &&
              (t = V.numberFormat(i / n, -1) + o[s]);
        return (
          t === M &&
            (t =
              1e4 <= it(i)
                ? V.numberFormat(i, -1)
                : V.numberFormat(i, -1, M, "")),
          t
        );
      },
          ...
          Tt(t.series, function (i) {
            if (i.visible || !e.options.chart.ignoreHiddenSeries) {
              ...
              (t.hasVisibleSeries = !0),
                ...
                t.isXAxis
                  ? (r = i.xData).length &&
                    ((t.dataMin = et(Nt(t.dataMin, r[0]), k(r))),
                    (t.dataMax = tt(Nt(t.dataMax, r[0]), C(r))))
                  : (i.getExtremes(),
                    (n = i.dataMax),
                    p((i = i.dataMin)) &&
                      p(n) &&
                      ((t.dataMin = et(Nt(t.dataMin, i), i)),
      ...
      translate: function (t, e, i, n, r, o) {
        ...
        return (
          ...
          e
            ? ((t = (t = t * a + c - u) / l + n), r && (t = s.lin2val(t)))
            : (r && (t = s.val2lin(t)),
              "between" === o && (o = 0.5),
              (t =
                a * (t - n) * l +
                c +
                a * u +
                (h(o) ? l * o * s.pointRange : 0))),
          t
        );
      },
      toPixels: function (t, e) {
        return (
          this.translate(t, !1, !this.horiz, null, !0) + (e ? 0 : this.pos)
        );
      },
      ...
      getPlotLinePath: function (t, e, i, n, r) {
        var o,
          ...
          c = this.left,
          l = this.top,
          u = (i && h.oldChartHeight) || h.chartHeight,
          p = (i && h.oldChartWidth) || h.chartWidth;
        o = this.transB;
        var d = function (t, e, i) {
          return (t < e || t > i) && (n ? (t = et(tt(e, t), i)) : (a = !0)), t;
        };
        return (
          (r = Nt(r, this.translate(t, null, null, i))),
          (t = i = K(r + o)),
          (o = s = K(u - r - o)),
          isNaN(r)
            ? (a = !0)
      ...
      getLinearTickPositions: function (t, e, i) {
        var n,
          ...
          s = [];
        if (e === i && h(e)) return [e];
        for (e = r; e <= o && (s.push(e), (e = S(e + t)) !== n); ) n = e;
        return s;
      },
      getMinorTickPositions: function () {
        ...
        if (s && s / n < this.len / 3)
          if (this.isLog)
            for (o = i.length, t = 1; t < o; t++)
              r = r.concat(this.getLogTickPositions(n, i[t - 1], i[t], !0));
          else if (this.isDatetimeAxis && "auto" === e.minorTickInterval)
            r = r.concat(
              this.getTimeTicks(
                this.normalizeTimeTickInterval(n),
                t,
                o,
                e.startOfWeek
              )
            );
          else for (i = t + ((i[0] - t) % n); i <= o; i += n) r.push(i);
        return (
          0 !== r.length && this.trimTicks(r, e.startOnTick, e.endOnTick), r
        );
      },
        ...
        this.isXAxis &&
          ...
          (p(s.min) || p(s.max)
            ...
            : (Tt(this.series, function (t) {
                for (
                  r = t.xData, i = t.xIncrement ? 1 : r.length - 1;
                  0 < i;
                  i--
                )
                  (n = r[i] - r[i - 1]), (e === M || n < e) && (e = n);
              }),
              (this.minRange = et(5 * e, this.dataMax - this.dataMin)))),
          h - a < this.minRange &&
            ((t = [
              a - (t = ((o = this.minRange) - h + a) / 2),
              Nt(s.min, a - t),
            ]),
            c && (t[2] = this.dataMin),
            ...
            c && (h[2] = this.dataMax),
            (h = k(h)) - a < o &&
              ((t[0] = h - o), (t[1] = Nt(s.min, h - o)), (a = C(t)))),
          (this.min = a),
          (this.max = h);
      },
      setAxisTranslation: function (t) {
        ...
        (u || c || r) &&
          (h
            ? ((s = h.minPointOffset), (a = h.pointRangePadding))
      ...
      setTickInterval: function (t) {
        ...
        d || b || g || this.getTickAmount(),
          ...
          u &&
            (!t && 0 >= et(s.min, Nt(s.dataMin, s.min)) && e(10, 1),
            (s.min = S(c(s.min), 15)),
            (s.max = S(c(s.max), 15))),
          s.range &&
            p(s.max) &&
            ((s.userMin = s.min = r = tt(s.min, s.minFromRange())),
            (s.userMax = o = s.max),
            (s.range = null)),
          s.beforePadding && s.beforePadding(),
          s.adjustForMinRange(),
          !(b || s.axisPointRange || s.usePercentage || g) &&
            p(s.min) &&
            p(s.max) &&
            (a = s.max - s.min) &&
            (!p(r) && y && (s.min -= a * y), !p(o) && m && (s.max += a * m)),
          h(l.floor) && (s.min = tt(s.min, l.floor)),
          h(l.ceiling) && (s.max = et(s.max, l.ceiling)),
          k &&
            p(s.dataMin) &&
            ((w = w || 0),
            !p(r) && s.min < w && s.dataMin >= w
              ? (s.min = w)
              : !p(o) && s.max > w && s.dataMax <= w && (s.max = w)),
          (s.tickInterval =
            s.min === s.max || void 0 === s.min || void 0 === s.max
              ? 1
              : g && !v && x === s.linkedParent.options.tickPixelInterval
              ? (v = s.linkedParent.tickInterval)
              : Nt(
                  v,
                  this.tickAmount
                    ? (s.max - s.min) / tt(this.tickAmount - 1, 1)
                    : void 0,
                  b ? 1 : ((s.max - s.min) * x) / tt(s.len, x)
                )),
          f &&
            !t &&
            Tt(s.series, function (t) {
              t.processData(s.min !== s.oldMin || s.max !== s.oldMax);
            }),
          s.setAxisTranslation(!0),
          s.beforeSetTickPositions && s.beforeSetTickPositions(),
          s.postProcessTickInterval &&
            (s.tickInterval = s.postProcessTickInterval(s.tickInterval)),
          s.pointRange &&
            !v &&
            (s.tickInterval = tt(s.pointRange, s.tickInterval)),
          (t = Nt(l.minTickInterval, s.isDatetimeAxis && s.closestPointRange)),
          !v && s.tickInterval < t && (s.tickInterval = t),
          d ||
            u ||
            v ||
            (s.tickInterval = (function (t, e, i, n, r) {
              var o,
                s = t;
              for (
                o = t / (i = Nt(i, 1)),
              ...
              s.tickInterval,
              null,
              Z.pow(10, J(Z.log(s.tickInterval) / Z.LN10)),
              Nt(
                l.allowDecimals,
                !(
                  0.5 < s.tickInterval &&
      ...
      setTickPositions: function () {
        ...
        (this.tickmarkOffset =
          ...
          (this.minorTickInterval =
            "auto" === i.minorTickInterval && this.tickInterval
              ? this.tickInterval / 5
              : i.minorTickInterval),
          (this.tickPositions = t = n && n.slice()),
          !t &&
            ((t = this.isDatetimeAxis
              ? this.getTimeTicks(
              ...
              : this.getLinearTickPositions(
                  ...
                  this.min,
                  this.max
                )).length > this.len && (t = [t[0], t.pop()]),
            (this.tickPositions = t),
            r && (r = r.apply(this, [this.min, this.max]))) &&
            (this.tickPositions = t = r),
          this.isLinked ||
            (this.trimTicks(t, o, s),
            this.min === this.max &&
              p(this.min) &&
              !this.tickAmount &&
              ((e = !0), (this.min -= 0.5), (this.max += 0.5)),
            (this.single = e),
      ...
      alignToOthers: function () {
        ...
        return (
          !1 !== this.chart.options.chart.alignTicks &&
            !1 !== i.alignTicks &&
            Tt(this.chart[this.coll], function (i) {
              var n = i.options;
      ...
      zoom: function (t, e) {
        ...
        return (
          this.allowZoomOutside ||
            (p(i) && t <= o && (t = o), p(n) && e >= r && (e = r)),
          (this.displayBtn = t !== M || e !== M),
          this.setExtremes(t, e, !1, M, { trigger: "zoom" }),
          !0
        );
      },
      setAxisSize: function () {
        ...
        (e = /%$/).test(r) &&
          (r = Math.round((parseFloat(r) / 100) * t.plotHeight)),
          e.test(o) &&
            (o = Math.round((parseFloat(o) / 100) * t.plotHeight + t.plotTop)),
          (this.left = s),
          (this.top = o),
          (this.width = n),
          (this.height = r),
      ...
      getThreshold: function (t) {
        ...
        return (
          null === t ? (t = 0 > i ? i : e) : e > t ? (t = e) : i < t && (t = i),
          this.translate(t, 0, 1, 0, 1)
        );
      },
      autoLabelAlign: function (t) {
        return 15 < (t = (Nt(t, 0) - 90 * this.side + 720) % 360) && 165 > t
          ? "right"
          : 195 < t && 345 > t
          ? "left"
          : "center";
      ...
      unsquish: function () {
        var t,
          ...
          a = s,
          h =
            this.len / (((this.categories ? 1 : 0) + this.max - this.min) / s),
          c = r.rotation,
          l = this.chart.renderer.fontMetrics(
            r.style.fontSize,
            n[0] && n[0].label
          ),
          u = Number.MAX_VALUE,
        ...
        return (
          o
            ? (i =
                ...
                (p(c)
                  ? [c]
                  : h < Nt(r.autoRotationLimit, 80) && r.autoRotation)) &&
              Tt(i, function (i) {
                var n;
                (i === c || (i && -90 <= i && 90 >= i)) &&
                  (n = (e = d(it(l.h / rt(st * i)))) + it(i / 360)) < u &&
                  ((u = n), (t = i), (a = e));
              })
            : r.step || (a = d(l.h)),
          (this.autoRotation = i),
      ...
      renderUnsquish: function () {
        var t,
          ...
          l = this.horiz,
          u = r.margin,
          p = this.categories ? a.length : a.length - 1,
          d =
            ((u = this.slotWidth =
              (l &&
                2 > (c.step || 0) &&
                !c.rotation &&
                ((this.staggerLines || 1) * r.plotWidth) / p) ||
              (!l && ((u[3] && u[3] - r.spacing[3]) || 0.33 * r.chartWidth))),
            tt(1, K(u - 2 * (c.padding || 5)))),
          f = {},
          g =
            ((p = s.fontMetrics(c.style.fontSize, h[0] && h[0].label)),
            c.style.textOverflow),
          m = 0;
        if (
          (o(c.rotation) || (f.rotation = c.rotation || 0), this.autoRotation)
        )
          Tt(a, function (t) {
        ...
        else if (u && ((t = { width: d + "px" }), !g))
          for (t.textOverflow = "clip", e = a.length; !l && e--; )
            (i = a[e]),
              (d = h[i].label) &&
                ("ellipsis" === d.styles.textOverflow &&
                  d.css({ textOverflow: "clip" }),
                (d.getBBox().height > this.len / a.length - (p.h - p.f) ||
                  h[i].labelLength > u) &&
                  (d.specCss = { textOverflow: "ellipsis" }));
        f.rotation &&
          ((t = {
            width:
              (m > 0.5 * r.chartHeight ? 0.33 * r.chartHeight : r.chartHeight) +
              "px",
          }),
      ...
      hasData: function () {
        return (
          ...
          (p(this.min) && p(this.max) && !!this.tickPositions)
        );
      },
      getOffset: function () {
        var t,
          ...
          n,
          r = this,
          o = (b = r.chart).renderer,
          s = r.options,
          a = r.tickPositions,
          h = r.ticks,
          c = r.horiz,
          l = r.side,
          u = b.inverted ? [1, 0, 3, 2][l] : l,
          d = 0,
          f = 0,
          g = s.title,
          m = s.labels,
        ...
        if (
          ...
          r.axisGroup ||
            ...
            (r.labelGroup = o
              ...
              .addClass("highcharts-" + r.coll.toLowerCase() + "-labels")
              .add(k))),
          t || r.isLinked)
        )
          Tt(a, function (t) {
        ...
        g &&
          ...
          (r.axisTitle ||
            ...
            (r.axisTitle.isNew = !0)),
          e &&
            ((d = r.axisTitle.getBBox()[c ? "height" : "width"]),
          ...
          (c =
            Math.abs(y) +
            f +
            (y && w * (c ? Nt(m.y, r.tickRotCorr.y + 8) : m.x) - o)),
      ...
      getTitlePosition: function () {
        ...
        (n = { low: s + (t ? 0 : n), middle: s + n / 2, high: s + (t ? n : 0) }[
          o.align
        ]),
          (e =
            (t ? i + this.height : e) +
            (t ? 1 : -1) * (a ? -1 : 1) * this.axisTitleMargin +
            (2 === this.side ? u : 0));
        return {
      ...
      render: function () {
        var t,
          ...
          x = n.tickmarkOffset,
          b = s.lineWidth,
          w = r.hasRendered && p(n.oldMin) && !isNaN(n.oldMin),
          k = n.showAxis,
          C = o.globalAnimation;
        (n.labelEdge.length = 0),
          ...
          (n.hasData() || h) &&
            (n.minorTickInterval &&
              !n.categories &&
              Tt(n.getMinorTickPositions(), function (t) {
            ...
            c.length &&
              (Tt(c, function (t, e) {
                (!h || (t >= n.min && t <= n.max)) &&
                  (d[t] || (d[t] = new L(n, t)),
                  w && d[t].isNew && d[t].render(e, !0, 0.1),
                  d[t].render(e));
              }),
              x &&
                (0 === n.min || n.single) &&
                (d[-1] || (d[-1] = new L(n, -1, null, !0)), d[-1].render(-1))),
            v &&
              Tt(c, function (t, o) {
                (i = c[o + 1] !== M ? c[o + 1] + x : n.max - x),
                  0 == o % 2 &&
                    t < n.max &&
                    i <= n.max + (r.polar ? -x : x) &&
                    (m[t] || (m[t] = new V.PlotLineOrBand(n)),
                    (e = t + x),
                    (m[t].options = {
                      from: a ? l(e) : e,
                      to: a ? l(i) : i,
            ...
            n._addedPlotLB ||
              (Tt((s.plotLines || []).concat(s.plotBands || []), function (t) {
          ...
          Tt([d, f, m], function (t) {
            var e,
              i,
              n = [],
              o = C ? C.duration || 500 : 0;
            for (e in t)
              t[e].isActive ||
                (t[e].render(e, !1, 0), (t[e].isActive = !1), n.push(e));
            g(
              function () {
                for (i = n.length; i--; )
                  t[n[i]] &&
                    !t[n[i]].isActive &&
                    (t[n[i]].destroy(), delete t[n[i]]);
              },
          ...
          b &&
            ((t = n.getLinePath(b)),
            n.axisLine
              ? n.axisLine.animate({ d: t })
              : (n.axisLine = o
                  .path(t)
                  .attr({ stroke: s.lineColor, "stroke-width": b, zIndex: 7 })
                  .add(n.axisGroup)),
            n.axisLine[k ? "show" : "hide"](!0)),
          u &&
            k &&
            (u[u.isNew ? "attr" : "animate"](n.getTitlePosition()),
            (u.isNew = !1)),
      ...
      destroy: function (t) {
        ...
        for (e in (t || Lt(i), n)) A(n[e]), (n[e] = null);
        for (
          Tt([i.ticks, i.minorTicks, i.alternateBands], function (t) {
            A(t);
          }),
            t = r.length;
          t--;
      ...
      drawCrosshair: function (t, e) {
        var i,
          ...
          r,
          o = this.crosshair;
        this.crosshair && !1 !== (p(e) || !Nt(o.snap, !0))
          ? (Nt(o.snap, !0)
              ? p(e) && (i = this.isXAxis ? e.plotX : this.len - e.plotY)
              : (i = this.horiz
                  ? t.chartX - this.pos
                  : this.len - t.chartY + this.pos),
            null ===
            (i = this.isRadial
              ? this.getPlotLinePath(this.isXAxis ? e.x : Nt(e.stackY, e.y)) ||
                null
              : this.getPlotLinePath(null, null, null, null, i) || null)
              ? this.hideCrosshair()
              : ((n = this.categories && !this.isRadial),
                ...
                this.cross
                  ...
                  : ((n = {
                      "stroke-width": r,
                      stroke:
                        o.color || (n ? "rgba(155,200,255,0.2)" : "#C0C0C0"),
      ...
      Rt(jt.prototype, {
        getPlotBandPath: function (t, e) {
          ...
          return (
            n && i
              ? ((n.flat = n.toString() === i.toString()),
                n.push(i[4], i[5], i[1], i[2]))
              : (n = null),
            n
          );
        },
        ...
        removePlotBandOrLine: function (t) {
          ...
          Tt(
            ...
            function (e) {
              for (r = e.length; r--; ) e[r].id === t && u(e, e[r]);
            }
          );
        },
      });
    var Wt,
      Xt = (V.Tooltip = function () {
        this.init.apply(this, arguments);
      });
    (Xt.prototype = {
      init: function (t, e) {
      ...
      getAnchor: function (t, e) {
        var i,
          ...
          l = 0;
        return (
          (i = (t = f(t))[0].tooltipPos),
          this.followPointer &&
            e &&
            (e.chartX === M && (e = o.pointer.normalize(e)),
          ...
          i ||
            (Tt(t, function (t) {
              (n = t.series.yAxis),
                ...
                (l +=
                  (t.plotLow ? (t.plotLow + t.plotHigh) / 2 : t.plotY) +
                  (!s && n ? n.top - a : 0));
            }),
            (c /= t.length),
            (l /= t.length),
      ...
      getPosition: function (t, e, i) {
        var n,
          ...
          l = Nt(
            i.ttBelow,
            (r.inverted && !i.negative) || (!r.inverted && i.negative)
          ),
          u = function (t, e, i, n, r, h) {
            var c = i < n - o,
              u = n + o + i < e,
              p = n - o - i;
            if (((n += o), l && u)) s[t] = n;
            else if (!l && c) s[t] = p;
            else if (c) s[t] = et(h - i, 0 > p - a ? p : p - a);
            else {
              if (!u) return !1;
          ...
          f = function () {
            !1 !== u.apply(0, h)
              ? !1 !== p.apply(0, c) || n || (d(!0), f())
              : n
              ? (s.x = s.y = 0)
              : (d(!0), f());
          };
        return (r.inverted || 1 < this.len) && d(), f(), s;
      },
      defaultFormatter: function (t) {
        var e,
          i = this.points || f(this);
        return (
      ...
      refresh: function (t, e) {
        ...
        clearTimeout(this.hideTimer),
          ...
          (n = r[1]),
          !p || (t.series && t.series.noSharedTooltip)
            ? (c = t.getLabelConfig())
            : ((s.hoverPoints = t),
              c &&
                Tt(c, function (t) {
              ...
              ((c = { x: t[0].category, y: t[0].y }).points = l),
              (this.len = l.length),
              (t = t[0])),
          (o = o.call(c, this)),
          (c = t.series),
          ...
          !1 === o
            ? this.hide()
            : (this.isHidden && (Ot(a), a.attr("opacity", 1).show()),
              a.attr({ text: o }),
      ...
      updatePosition: function (t) {
        var e = this.chart,
          i = this.label;
        i = (this.options.positioner || this.getPosition).call(
          this,
          i.width,
          i.height,
          t
      ...
      getXDateFormat: function (t, e, i) {
        ...
        var r,
          ...
          h = "millisecond";
        if (s) {
          for (r in ((o = R("%m-%d %H:%M:%S.%L", t.x)), N)) {
            if (
              s === N.week &&
              +R("%w", t.x) === i.options.startOfWeek &&
    ...
    _t.prototype = {
      ...
      normalize: function (e, i) {
        var n, r;
        return (
          (e = e || t.event).target || (e.target = e.srcElement),
          (r = e.touches
            ? e.touches.length
              ? e.touches.item(0)
              : e.changedTouches[0]
          ...
          r.pageX === M
            ? ((n = tt(e.x, e.clientX - i.left)), (r = e.y))
            : ((n = r.pageX - i.left), (r = r.pageY - i.top)),
          Rt(e, { chartX: K(n), chartY: K(r) })
        );
      },
      getCoordinates: function (t) {
        var e = { xAxis: [], yAxis: [] };
        return (
          Tt(this.chart.axes, function (i) {
      ...
      runPointActions: function (t) {
        ...
        if (
          (c && (a ? c.noSharedTooltip : c.directTouch) && h
            ? (p = [h])
            : (Tt(o, function (r) {
                (e = r.noSharedTooltip && a),
                  ...
                  r.visible &&
                    !e &&
                    !i &&
                    Nt(r.options.enableMouseTracking, !0) &&
                    (n = r.searchPoint(t, !e && 1 === r.kdDimensions)) &&
                    u.push(n);
              }),
              Tt(u, function (t) {
                t &&
                  Tt(["dist", "distX"], function (e, i) {
                    "number" == typeof t[e] &&
                      t[e] < l[i] &&
                      ((l[i] = t[e]), (p[i] = t));
                  });
          ...
          for (r = u.length; r--; )
            (u[r].clientX !== p[1].clientX || u[r].series.noSharedTooltip) &&
              u.splice(r, 1);
        p[0] && (p[0] !== this.prevKDPoint || (s && s.isHidden))
          ? a && !p[0].series.noSharedTooltip
            ? (u.length && s && s.refresh(u, t),
              Tt(u, function (e) {
          ...
          : ((o = c && c.tooltipOptions.followPointer),
            s &&
              o &&
              !s.isHidden &&
              ((o = s.getAnchor([{}], t)),
              s.updatePosition({ plotX: o[0], plotY: o[1] }))),
          this._onDocumentMouseMove ||
            ((this._onDocumentMouseMove = function (t) {
          ...
          Tt(a ? u : [Nt(p[1], h)], function (e) {
            var i = e && e.series;
            i &&
              Tt(["xAxis", "yAxis", "colorAxis"], function (n) {
            ...
            ? (s.refresh(a),
              r &&
                ...
                Tt(i.axes, function (t) {
                  Nt(t.options.crosshair && t.options.crosshair.snap, !0)
      ...
      drag: function (t) {
        ...
        (p && p.touch) ||
          ...
          (this.hasDragged = Math.sqrt(
            Math.pow(d - r, 2) + Math.pow(f - o, 2)
          )),
          10 < this.hasDragged &&
            ((e = i.isInsidePlot(d - h, f - c)),
            i.hasCartesianSeries &&
              (this.zoomX || this.zoomY) &&
              e &&
              !g &&
              !p &&
              (this.selectionMarker = p =
                i.renderer
                  .rect(h, c, s ? 1 : l, a ? 1 : u, 0)
                  .attr({
            ...
            p &&
              s &&
              ((r -= d), p.attr({ width: it(r), x: (0 < r ? 0 : r) + d })),
            p &&
              a &&
              ((r = o - f), p.attr({ height: it(r), y: (0 < r ? 0 : r) + f })),
      ...
      drop: function (t) {
        ...
        if (this.selectionMarker) {
          var r,
            ...
            h = s.attr ? s.attr("y") : s.y,
            c = s.attr ? s.attr("width") : s.width,
            l = s.attr ? s.attr("height") : s.height;
          (this.hasDragged || n) &&
            (Tt(i.axes, function (i) {
              if (
                i.zoomEnabled &&
                p(i.min) &&
                ...
                o[i.coll].push({ axis: i, min: et(d, s), max: tt(d, s) }),
                  (r = !0);
              }
            }),
            r &&
              Mt(i, "selection", o, function (t) {
        ...
        i &&
          (m(i.container, { cursor: i._cursor }),
        ...
        (t = this.normalize(t)),
          e.cancelClick ||
            (i && this.inClass(t.target, "highcharts-tracker")
              ? (Mt(i.series, "click", Rt(t, { point: i })),
                e.hoverPoint && i.firePointEvent("click", t))
              : (Rt(t, this.getCoordinates(t)),
                e.isInsidePlot(t.chartX - n, t.chartY - r) &&
                  Mt(e, "click", t)));
      },
      ...
      destroy: function () {
        ...
        xt ||
          (Lt($, "mouseup", this.onDocumentMouseUp),
    ...
    Gt.prototype = {
      ...
      colorizeItem: function (t, e) {
        var i,
          ...
          h =
            ...
            e ? t.legendColor || t.color || "#CCC" : a),
          c = ((a = t.options && t.options.marker), { fill: h });
        if (
          (r && r.css({ fill: n, color: n }), o && o.attr({ stroke: h }), s)
        ) {
          if (a && s.isMarker)
            for (i in ((c.stroke = h), (a = t.convertAttribs(a))))
              (r = a[i]) !== M && (c[i] = r);
          s.attr(c);
        }
      },
      positionItem: function (t) {
        ...
        (t = t.legendGroup) &&
          t.element &&
          t.translate(i ? n : this.legendWidth - n - 2 * e - 4, r),
          o && ((o.x = n), (o.y = r));
      },
      ...
      renderTitle: function () {
        ...
        e.text &&
          ...
          this.contentGroup.attr({ translateY: i })),
          (this.titleHeight = i);
      },
      setText: function (t) {
        var e = this.options;
      ...
      renderItem: function (t) {
        ...
        y ||
          ...
          (t.legendItem = y =
            i
              .text("", p ? s + a : -a, this.baseline || 0, b)
              .css(n(t.visible ? h : c))
              .attr({ align: p ? "left" : "right", zIndex: 2 })
              .add(t.legendGroup)),
          this.baseline ||
            ((this.fontMetrics = i.fontMetrics(h.fontSize, y)),
          ...
          o &&
            this.itemX - m + s > (d || e.chartWidth - 2 * l - m - r.x) &&
            ((this.itemX = m),
          ...
          o
            ? (this.itemX += s)
            : ((this.itemY += g + a + f), (this.lastLineHeight = a)),
          (this.offsetWidth =
            d || tt((o ? this.itemX - m - u : s) + l, this.offsetWidth));
      },
      getAllItems: function () {
        var t = [];
        return (
          Tt(this.chart.series, function (e) {
            var i = e.options;
            Nt(i.showInLegend, !p(i.linkedTo) && M, !0) &&
              (t = t.concat(
      ...
      adjustMargins: function (t, e) {
        var i = this.chart,
          n = this.options,
          r =
            n.align.charAt(0) + n.verticalAlign.charAt(0) + n.layout.charAt(0);
        this.display &&
          !n.floating &&
          Tt(
      ...
      render: function () {
        ...
        (r.itemX = r.initialItemX),
          ...
          (r.lastItemY = 0),
          a ||
            ((r.group = a = s.g("legend").attr({ zIndex: 7 }).add()),
            (r.contentGroup = s.g().attr({ zIndex: 1 }).add(a)),
            ...
            (h
              ? 0 < i &&
                ...
                (h[h.isNew ? "attr" : "animate"](
                  h.crisp({ width: i, height: n })
                ),
                (h.isNew = !1))
              : ((r.box = h =
                  s
                    .rect(0, 0, i, n, c.borderRadius, u || 0)
                    .attr({
          ...
          e && a.align(Rt({ width: i, height: n }, c), !0, "spacingBox"),
      ...
      handleOverflow: function (t) {
        var e,
          ...
          y = function (t) {
            c.attr({ height: t }),
              n.contentGroup.div &&
                (n.contentGroup.div.style.clip =
                  "rect(" + g + "px,9999px," + (g + t) + "px,0)");
          };
        return (
          "horizontal" === s.layout && (a /= 2),
          h && (a = et(a, h)),
          (f.length = 0),
          t > a
            ? ((this.clipHeight = e = tt(a - 20 - this.titleHeight - g, 0)),
              ...
              Tt(m, function (t, n) {
                var r = t._legendItemPos[1],
                  ...
                  s = f.length;
                (!s || (r - f[s - 1] > e && (i || r) !== f[s - 1])) &&
                  (f.push(i || r), s++),
                  n === m.length - 1 && r + o - f[s - 1] > e && f.push(r),
                  r !== i && (i = r);
              }),
              c ||
                ((c = n.clipRect = o.clipRect(0, g, 9999, 0)),
                n.contentGroup.clip(c)),
              y(e),
              d ||
                ((this.nav = d = o.g().attr({ zIndex: 1 }).add(this.group)),
                (this.up = o
      ...
      scroll: function (t, e) {
        ...
        if ((r > n && (r = n), 0 < r)) {
          ...
          this.nav.attr({
            ...
            this.up
              .attr({ fill: 1 === r ? a : s })
              .css({ cursor: 1 === r ? "default" : "pointer" }),
            h.attr({ text: r + "/" + n }),
            this.down
              .attr({
              ...
              .css({ cursor: r === n ? "default" : "pointer" }),
            (i = -i[r - 1] + this.initialItemY),
            this.scrollGroup.animate({ translateY: i }),
            (this.currentPage = r),
    ...
    var Yt = (V.LegendSymbolMixin = {
      ...
      drawLineMarker: function (t) {
        var e,
          ...
          s = this.legendGroup;
        (t = t.baseline - K(0.3 * t.fontMetrics.b)),
          i.lineWidth &&
            ((e = { "stroke-width": i.lineWidth }),
          ...
          n &&
            ...
            ((i = n.radius),
            (this.legendSymbol = n =
              o.symbol(this.symbol, r / 2 - i, t - i, 2 * i, 2 * i, n).add(s)),
            (n.isMarker = !0));
      },
    });
    (/Trident\/7\.0/.test(at) || ut) &&
      Dt(Gt.prototype, "positionItem", function (t, e) {
        var i = this,
          n = function () {
    ...
    (V.chart = function (t, e, i) {
      ...
      (Ut.prototype = {
        ...
        initSeries: function (t) {
          ...
          return (
            (i = kt[t.type || i.type || i.defaultSeriesType]) || e(17, !0),
            (i = new i()).init(this, t),
            i
          );
        },
        ...
        redraw: function (t) {
          var e,
            ...
            f = [];
          for (
            this.renderer.globalAnimation = Nt(t, this.animation),
              d && this.cloneRenderTo(),
              this.layOutTitles();
            u--;

          )
            if ((t = r[u]).options.stacking && ((e = !0), t.isDirty)) {
              i = !0;
              break;
            }
          if (i)
            for (u = l; u--; ) (t = r[u]).options.stacking && (t.isDirty = !0);
          Tt(r, function (t) {
            t.isDirty &&
              "point" === t.options.legendType &&
              (t.updateTotals && t.updateTotals(), (a = !0));
          }),
            a && s.options.enabled && (s.render(), (this.isDirtyLegend = !1)),
            e && this.getStacks(),
            h &&
              !this.isResizing &&
              ((this.maxTicks = null),
        ...
        layOutTitles: function (t) {
          ...
          i &&
            (i
              .css({ width: (r.width || a) + "px" })
              .align(
                Rt({ y: s.fontMetrics(r.style.fontSize, i).b - 3 }, r),
                !1,
                "spacingBox"
              ),
                  ...
                  Rt(
                    {
                      y:
                        e +
                        (r.margin - 13) +
                        s.fontMetrics(o.style.fontSize, i).b,
                    },
                    o
                  ),
                  !1,
        ...
        getChartSize: function () {
          ...
          p(t) || (this.containerWidth = Ct(i, "width")),
            ...
            (this.chartHeight = tt(
              0,
              Nt(e, 19 < this.containerHeight ? this.containerHeight : 400)
            ));
        },
        cloneRenderTo: function (t) {
          ...
          t
            ? e &&
              (this.renderTo.appendChild(i), T(e), delete this.renderToClone)
            : (i &&
                i.parentNode === this.renderTo &&
                this.renderTo.removeChild(i),
              (this.renderToClone = e = this.renderTo.cloneNode(0)),
              m(e, { position: "absolute", top: "-9999px", display: "block" }),
              e.style.setProperty &&
          ...
          t || (this.renderTo = t = a.renderTo),
            ...
            (this.container = t =
              y(
                ...
                this.renderToClone || t
              )),
            (this._cursor = t.style.cursor),
            (this.renderer = new (V[a.renderer] || Ht)(
              t,
              i,
              n,
              a.style,
        ...
        getMargins: function (t) {
          ...
          this.resetMargins(),
            n &&
              ...
              (this.plotTop = tt(
                this.plotTop,
                n + this.options.title.margin + e[0]
              )),
        ...
        reflow: function (e) {
          ...
          i.hasUserSize ||
            ...
            !s ||
            (n !== t && n !== $) ||
            ((o === i.containerWidth && s === i.containerHeight) ||
              (clearTimeout(i.reflowTimeout),
              (i.reflowTimeout = g(
                function () {
        ...
        setSize: function (t, e, i) {
          ...
          (o.isResizing += 1),
            ...
            p(t) && ((o.chartWidth = n = tt(0, K(t))), (o.hasUserSize = !!n)),
            p(e) && (o.chartHeight = r = tt(0, K(e))),
            ((t = s.globalAnimation) ? Ft : m)(
              o.container,
        ...
        setChartSize: function (t) {
          ...
          (this.plotLeft = e = K(this.plotLeft)),
            ...
            (this.plotBox = s.plotBox = { x: e, y: i, width: n, height: r }),
        ...
        drawChartBox: function () {
          ...
          (t = c + (e.shadow ? 8 : 0)),
            (c || l) &&
              (o
                ? o.animate(o.crisp({ width: n - t, height: r - t }))
                : ((o = { fill: l || "none" }),
                  c && ((o.stroke = e.borderColor), (o["stroke-width"] = c)),
                  (this.chartBackground = i
                    .rect(t / 2, t / 2, n - t, r - t, e.borderRadius, c)
                    .attr(o)
            ...
            p &&
              (h
                ? h.animate(v)
                : (this.plotBGImage = i.image(p, f, g, m, y).add())),
            x
            ...
            d &&
              (a
                ? ((a.strokeWidth = -d),
                  a.animate(a.crisp({ x: f, y: g, width: m, height: y })))
                : (this.plotBorder = i
                    .rect(f, g, m, y, 0, -d)
                    .attr({
        ...
        propFromSeries: function () {
          ...
          Tt(["inverted", "angular", "polar"], function (s) {
            for (
              t = kt[r.type || r.defaultSeriesType],
        ...
        renderLabels: function () {
          var t = this,
            e = t.options.labels;
          e.items &&
            Tt(e.items, function (i) {
              var n = Rt(e.style, i.style),
                o = r(n.left) + t.plotLeft,
                s = r(n.top) + t.plotTop + 12;
              delete n.left,
                delete n.top,
                t.renderer.text(i.html, o, s).attr({ zIndex: 2 }).css(n).add();
            });
        },
        render: function () {
          var t,
        ...
        isReadyToRender: function () {
          ...
          return (
            !(
              (!dt && t == t.top && "complete" !== $.readyState) ||
              (gt && !t.canvg)
            ) ||
            (gt
              ? CanVGController.push(function () {
                  e.firstRender();
                }, e.options.global.canvasToolsURL)
    ...
    qt.prototype = {
      ...
      applyOptions: function (t, e) {
        ...
        return (
          (t = qt.prototype.optionsToObject.call(this, t)),
          Rt(this, t),
      ...
      optionsToObject: function (t) {
        var e = {},
          ...
          s = 0,
          h = 0;
        if ("number" == typeof t || null === t) e[r[0]] = t;
        else if (a(t))
          for (
            !n &&
            t.length > o &&
      ...
      destroy: function () {
        ...
        i && (this.setState(), u(i, this), i.length || (e.hoverPoints = null)),
        this === e.hoverPoint && this.onMouseOut(),
        (this.graphic || this.dataLabel) && (Lt(this), this.destroyElements()),
      ...
      tooltipFormatter: function (t) {
        var e = this.series,
          ...
          o = i.valueSuffix || "";
        return (
          Tt(e.pointArrayMap || ["y"], function (e) {
            (e = "{point." + e),
              (r || o) && (t = t.replace(e + "}", r + e + "}" + o)),
              (t = t.replace(e + "}", e + ":,." + n + "f}"));
          }),
          b(t, { point: this, series: this.series })
        );
      },
    ...
    Vt.prototype = {
          ...
          Tt(r[o], function (e) {
            (t = e.options),
              (n[o] === t.index ||
                (n[o] !== M && n[o] === t.id) ||
                (n[o] === M && 0 === t.index)) &&
                (e.series.push(i), (i[o] = e), (e.isDirty = !0));
          }),
      ...
      autoIncrement: function () {
        ...
        return (
          (this.pointInterval = t = Nt(this.pointInterval, e.pointInterval, 1)),
          ("month" !== n && "year" !== n) ||
            ((e = new D(i)),
            (t =
              (e = "month" === n ? +e[U](e[G]() + t) : +e[q](e[Y]() + t)) - i)),
          (this.xIncrement = i + t),
          i
        );
      },
      setOptions: function (t) {
        var e,
          i = (e = this.chart).options.plotOptions,
        ...
        return (
          ...
          (this.tooltipOptions = n(
            I.tooltip,
            I.plotOptions[this.type].tooltip,
            e.tooltip,
            r.series && r.series.tooltip,
            r[this.type] && r[this.type].tooltip,
            t.tooltip
          )),
          null === o.marker && delete i.marker,
          (this.zoneAxis = i.zoneAxis),
          (t = this.zones = (i.zones || []).slice()),
          (!i.negativeColor && !i.negativeFillColor) ||
            i.zones ||
            t.push({
      ...
      getCyclic: function (t, e, i) {
        ...
        e ||
          (p(n[r])
            ? (e = n[r])
            : ((n[r] = e = this.chart[o] % i.length), (this.chart[o] += 1)),
          (e = i[e])),
          (this[t] = e);
      },
      getColor: function () {
        this.options.colorByPoint
          ...
          : this.getCyclic(
              "color",
              this.options.color || zt[this.type].color,
      ...
      setData: function (t, i, n, r) {
        ...
        if (
          ...
          if (
            ...
            for (n = 0; null === g && n < s; ) (g = t[n]), n++;
            if (h(g)) {
              for (
                y = Nt(d.pointStart, 0), g = Nt(d.pointInterval, 1), n = 0;
                n < s;
                n++
              )
                (x[n] = y), (b[n] = t[n]), (y += g);
              ...
              if (w)
                for (n = 0; n < s; n++)
                  (g = t[n]), (x[n] = g[0]), (b[n] = g.slice(1, w + 1));
              else
                for (n = 0; n < s; n++)
                  (g = t[n]), (x[n] = g[0]), (b[n] = g[1]);
            else e(12);
          } else
            for (n = 0; n < s; n++)
              t[n] !== M &&
      ...
      processData: function (t) {
        ...
        if (d && !this.isDirty && !c.isDirty && !this.yAxis.isDirty && !t)
          return !1;
        for (
          c && ((l = (t = c.getExtremes()).min), (u = t.max)),
            d &&
              this.sorted &&
              !p &&
              ...
              (n[o - 1] < l || n[0] > u
                ? ((n = []), (r = []))
                : (n[0] < l || n[o - 1] > u) &&
                  ((n = (i = this.cropData(this.xData, this.yData, l, u))
                    .xData),
                  (r = i.yData),
                  (i = i.start),
                  (s = !0))),
          ...
          0 < (o = g ? f(n[h]) - f(n[h - 1]) : n[h] - n[h - 1]) &&
          (a === M || o < a)
            ? (a = o)
            : 0 > o && this.requireSorting && e(15);
        (this.cropped = s),
          (this.cropStart = i),
      ...
      generatePoints: function () {
        var t,
          ...
          p = [];
        for (
          o || u || (((o = []).length = r.length), (o = this.data = o)), n = 0;
          n < c;
          n++
        )
          (e = l + n),
            u
              ? (p[n] = new h().init(this, [s[n]].concat(f(a[n]))))
              : (o[e]
                  ? (i = o[e])
                  : r[e] !== M && (o[e] = i = new h().init(this, r[e], s[n])),
                (p[n] = i)),
            (p[n].index = e);
        if (o && (c !== (t = o.length) || u))
          for (n = 0; n < t; n++)
            n !== l || u || (n += c),
              o[n] && (o[n].destroyElements(), (o[n].plotX = M));
      ...
      getExtremes: function (t) {
        var e,
          ...
          h = [],
          c = 0,
          l = (e = this.xAxis.getExtremes()).min,
          u = e.max;
        for (
          e = (t = t || this.stackedYData || this.processedYData).length, o = 0;
          o < e;
          o++
        )
          if (
            ...
            if ((i = r.length)) for (; i--; ) null !== r[i] && (h[c++] = r[i]);
            else h[c++] = r;
      ...
      translate: function () {
        ...
        for (
          ...
          var C =
            o &&
            c.stacks[
              (this.negStacks && k < (y ? 0 : m) ? "-" : "") + this.stackKey
            ];
          c.isLog && null !== k && 0 >= k && ((b.y = k = null), e(10)),
            (b.plotX = t =
              et(
                tt(-1e5, s.translate(w, 0, 0, 0, 1, f, "flags" === this.type)),
                1e5
              )),
            o &&
              this.visible &&
              ...
              C &&
              C[w] &&
              ((r = this.getStackIndicator(r, w, this.index)),
            ...
            (b.plotY = i =
              "number" == typeof k && 1 / 0 !== k
                ? et(tt(-1e5, c.translate(k, 0, 1, 0, 1)), 1e5)
                : M),
            (b.isInside =
              i !== M && 0 <= i && i <= c.len && 0 <= t && t <= s.len),
        ...
        h ||
          (t &&
            ...
            (e[a + "m"] = c =
              n.clipRect(
                -99,
                r ? -e.plotLeft : -e.plotTop,
                99,
                r ? e.chartWidth : e.chartHeight
              ))),
          (e[a] = h = n.clipRect(s))),
          t && (h.count += 1),
          !1 !== i.clip &&
      ...
      animate: function (t) {
        ...
        n && !s(n) && (n = zt[this.type].animation),
          t
            ? this.setClip(n)
            : ((t = i[(e = this.sharedClipKey)]) &&
                t.animate({ width: i.plotSizeX }, n),
              i[e + "m"] && i[e + "m"].animate({ width: i.plotSizeX + 99 }, n),
              (this.animate = null));
      },
      afterAnimate: function () {
        this.setClip(), Mt(this, "afterAnimate");
      },
      drawPoints: function () {
        var t,
          e,
        ...
        if (!1 !== f.enabled || this._hasPointMarkers)
          for (n = p.length; n--; )
            (r = p[n]),
              ...
              (u = r.isInside),
              t && i !== M && !isNaN(i) && null !== r.y
                ? ((o = (t = r.pointAttr[r.selected ? "select" : ""] || g).r),
                  ...
                  h
                    ? h[u ? "show" : "hide"](!0)
                        ...
                        .animate(
                          Rt(
                            { x: e - o, y: i - o },
                            h.symbolName ? { width: 2 * o, height: 2 * o } : {}
                          )
                        )
                    : u &&
                      (0 < o || a) &&
                      (r.graphic = d.renderer
                        .symbol(s, e - o, i - o, 2 * o, 2 * o, l ? c : f)
                        .attr(t)
                        .add(m)))
                : h && (r.graphic = h.destroy());
      },
      ...
      getAttribs: function () {
        ...
        if (
          (i.marker
            ? ((o.radius = o.radius || n.radius + o.radiusPlus),
              (o.lineWidth = o.lineWidth || n.lineWidth + o.lineWidthPlus))
            : ((o.color =
                o.color ||
                E(o.color || s)
                  .brighten(o.brightness)
                  .get()),
              (o.negativeColor =
                o.negativeColor ||
                E(o.negativeColor || a)
          ...
          for (; s--; ) {
            if (
              ((n = ((c = l[s]).options && c.options.marker) || c.options) &&
                !1 === n.enabled &&
                (n.radius = 0),
              y.length)
            ) {
              for (t = y[(h = 0)]; c[v] >= t.value; ) t = y[++h];
              c.color = c.fillColor = Nt(t.color, e.color);
            }
            if (((h = i.colorByPoint || c.color), c.options))
              for (m in d) p(n[d[m]]) && (h = !0);
            h
              ? ((h = []),
                (t = (r = (n = n || {}).states || {}).hover = r.hover || {}),
                (i.marker && (!c.negative || t.fillColor || o.fillColor)) ||
                  (t[e.pointAttrToOptions.fill] =
                    t.color ||
                    (!c.options.color &&
                      o[c.negative && a ? "negativeColor" : "color"]) ||
                    E(c.color)
                      .brighten(t.brightness || o.brightness)
                      .get()),
                (t = { color: c.color }),
                ...
                (h.select = e.convertAttribs(r.select, u.select, h[""])))
              : (h = u),
              (c.pointAttr = h);
          }
      },
      destroy: function () {
        var t,
          ...
          r = this,
          o = r.chart,
          s = /AppleWebKit\/533/.test(at),
          a = r.data || [];
        for (
          Mt(r, "destroy"),
            Lt(r),
            Tt(r.axisTypes || [], function (t) {
              (n = r[t]) && (u(n.series, r), (n.isDirty = n.forceRedraw = !0));
            }),
        ...
        for (i in ((r.points = null), clearTimeout(r.animationTimeout), r))
          r[i] instanceof B &&
            !r[i].survive &&
            ((t = s && "group" === i ? "hide" : "destroy"), r[i][t]());
      ...
      getGraphPath: function (t, e, i) {
        var n,
          ...
          h = [];
        return (
          (n = (t = t || o.points).reversed) && t.reverse(),
        ...
        Tt(this.zones, function (n, r) {
          ...
          Tt(i, function (i, a) {
            ...
            c
              ...
              : (n || s) &&
                o.length &&
                ((c = { stroke: i[1], "stroke-width": n, fill: s, zIndex: 1 }),
                i[2]
                  ? (c.dashstyle = i[2])
                  : r && (c["stroke-linecap"] = c["stroke-linejoin"] = "round"),
                (t[h] = t.chart.renderer
                  .path(o)
                  .attr(c)
                  .add(t.group)
                  .shadow(2 > a && e.shadow)));
      ...
      applyZones: function () {
        var t,
          ...
          p = this.graph,
          d = this.area,
          f = tt(h.chartWidth, h.chartHeight),
        ...
        l.length &&
          ...
          Tt(l, function (l, b) {
            (t = m ? (v ? h.plotWidth : 0) : v ? 0 : g.toPixels(n.min)),
              ...
              (s = tt(t, e)),
              g.isXAxis
                ? ((i = { x: y ? s : o, y: 0, width: r, height: f }),
                  v || (i.x = h.plotHeight - i.x))
                : ((i = { x: 0, y: y ? s : o, width: f, height: r }),
                  v && (i.y = h.plotWidth - i.y)),
              h.inverted &&
                c.isVML &&
                (i = g.isXAxis
                  ? { x: 0, y: m ? o : s, height: i.width, width: h.chartWidth }
                  : {
      ...
      plotGroup: function (t, e, i, n, r) {
        ...
        return (
          ...
          o.attr({ visibility: i })[s ? "attr" : "animate"](this.getPlotBox()),
          o
        );
      },
      getPlotBox: function () {
      ...
      redraw: function () {
        var t = this.chart,
          ...
          o = this.yAxis;
        n &&
          (t.inverted && n.attr({ width: t.plotWidth, height: t.plotHeight }),
          n.animate({
                ...
                if ((s = i && i.length))
                  return (
                    ...
                    }),
                    {
                      ...
                      left: e(i.slice(0, s), n + 1, r),
                      right: e(i.slice(s + 1), n + 1, r),
                    }
                  );
              })(t.getValidPoints(), e, e);
            },
            t.options.kdNow ? 0 : 1
          );
      },
      searchKDTree: function (t, e) {
        ...
        if ((this.kdTree || this.buildKDTree(), this.kdTree))
          return (function t(e, s, a, h) {
            ...
            return (
              (c =
                ((l = p(e[n]) && p(u[n]) ? Math.pow(e[n] - u[n], 2) : null) ||
                  0) +
                ((c = p(e[r]) && p(u[r]) ? Math.pow(e[r] - u[r], 2) : null) ||
                  0)),
              (u.dist = p(c) ? Math.sqrt(c) : Number.MAX_VALUE),
              (u.distX = p(l) ? Math.sqrt(l) : Number.MAX_VALUE),
              (l = 0 > (d = e[d] - u[d]) ? "right" : "left"),
              s[(c = 0 > d ? "left" : "right")] &&
                (f = (c = t(e, s[c], a + 1, h))[o] < f[o] ? c : u),
              s[l] &&
                Math.sqrt(d * d) < f[o] &&
                (f = (e = t(e, s[l], a + 1, h))[o] < f[o] ? e : f),
              f
            );
    ...
    var Zt = (V.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        var t = this,
          ...
          d = "rgba(192,192,192," + (dt ? 1e-4 : 0.002) + ")";
        if (r && !i)
          for (l = r + 1; l--; )
            "M" === n[l] && n.splice(l + 1, 0, n[l + 1] - h, n[l + 2], "L"),
              ((l && "M" === n[l]) || l === r) &&
                n.splice(l, 0, "L", n[l - 2] + h, n[l - 1]);
        c
          ? c.attr({ d: n })
          : ((t.tracker = a
              .path(n)
    ...
    return (
      kt.column && (ColumnSeries.prototype.drawTracker = Zt.drawTrackerPoint),
      ...
      Rt(Ut.prototype, {
        ...
        zoomOut: function () {
          var t = this;
          Mt(t, "selection", { resetSelection: !0 }, function () {
            t.zoom();
          });
        },
        zoom: function (t) {
          ...
          !t || t.resetSelection
            ...
            : Tt(t.xAxis.concat(t.yAxis), function (t) {
                var i = t.axis,
                  o = i.isXAxis;
                (n[o ? "zoomX" : "zoomY"] || n[o ? "pinchX" : "pinchY"]) &&
                  ((e = i.zoom(t.min, t.max)), i.displayBtn && (r = !0));
              }),
            (i = this.resetZoomButton),
            r && !i
              ? this.showResetZoom()
              : !r && s(i) && (this.resetZoomButton = i.destroy()),
            e &&
              this.redraw(
                Nt(
          ...
          r &&
            ...
            Tt("xy" === e ? [1, 0] : [1], function (e) {
              var r = (e = n[e ? "xAxis" : "yAxis"][0]).horiz,
                ...
                h = e.getExtremes(),
                c = e.toValue(s - o, !0) + a;
              (a = e.toValue(s + e.len - o, !0) - a), (s = s > o);
              e.series.length &&
                (s || c > et(h.dataMin, h.min)) &&
                (!s || a < tt(h.dataMax, h.max)) &&
                (e.setExtremes(c, a, !1, !1, { trigger: "pan" }), (i = !0)),
                (n[r] = o);
            }),
            i && n.redraw(!1),
            m(n.container, { cursor: "move" });
        },
      }),
      Rt(qt.prototype, {
        select: function (t, e) {
            ...
            i.firePointEvent(
              ...
              function () {
                (i.selected = i.options.selected = t),
                  ...
                  i.setState(t && "select"),
                  e ||
                    Tt(r.getSelectedPoints(), function (t) {
                      t.selected &&
                        t !== i &&
        ...
        onMouseOut: function () {
          ...
          this.firePointEvent("mouseOut"),
            (e && -1 !== At(this, e)) ||
              (this.setState(), (t.hoverPoint = null));
        },
        importEvents: function () {
          if (!this.hasImportedEvents) {
            var t,
              e = n(this.series.options.point, this.options).events;
            for (t in ((this.events = e), e)) Bt(this, t, e[t]);
        ...
        setState: function (t, e) {
          var i,
            ...
            s = this.series,
            a = s.options.states,
            h = zt[s.type].marker && s.options.marker,
            c = h && !h.enabled,
            l = h && h.states[t],
            u = l && !1 === l.enabled,
          ...
          (t = t || ""),
            ...
            (t === this.state && !e) ||
              ...
              (a[t] && !1 === a[t].enabled) ||
              (t && (u || (c && !1 === l.enabled))) ||
              (t && d.states && d.states[t] && !1 === d.states[t].enabled) ||
              (this.graphic
                ? ((h = h && this.graphic.symbolName && i.r),
                  this.graphic.attr(
                    n(
                      i,
                      h
                        ? { x: r - h, y: o - h, width: 2 * h, height: 2 * h }
                        : {}
                    )
                  ),
                  p && p.hide())
                : (t &&
                    ...
                    p
                      ? p[e ? "animate" : "attr"]({ x: r - h, y: o - h })
                      : d &&
                        ((s.stateMarkerGraphic = p =
                          f.renderer
                            .symbol(d, r - h, o - h, 2 * h, 2 * h)
                            .attr(i)
                            .add(s.markerGroup)),
                        (p.currentSymbol = d))),
                  p &&
                    (p[
                      t && f.isInsidePlot(r, o, f.inverted) ? "show" : "hide"
                    ](),
                    (p.element.point = this))),
              (r = a[t] && a[t].halo) && r.size
                ? (g || (s.halo = g = f.renderer.path().add(f.seriesGroup)),
                  g
                    .attr(
                      Rt(
                        {
                    ...
                    [e ? "animate" : "attr"]({ d: this.haloPath(r.size) }))
                : g && g.attr({ d: [] }),
              (this.state = t));
        },
        haloPath: function (t) {
          ...
          return i.renderer.symbols.circle(
            n.translateX + (r ? e.yAxis.len - this.plotY : o) - t,
            n.translateY + (r ? e.xAxis.len - o : this.plotY) - t,
            2 * t,
            2 * t
          );
        },
      ...
      Rt(Vt.prototype, {
        ...
        setState: function (t) {
          ...
          if (
            ((t = t || ""),
            this.state !== t &&
              ((this.state = t), !n[t] || !1 !== n[t].enabled) &&
              (t && (r = n[t].lineWidth || r + (n[t].lineWidthPlus || 0)),
              i && !i.dashstyle))
          )
            for (t = { "stroke-width": r }, i.attr(t); this["zoneGraph" + e]; )
              this["zoneGraph" + e].attr(t), (e += 1);
        },
        setVisible: function (t, e) {
          var i,
            ...
            a = n.visible;
          (i = (n.visible = t = n.userOptions.visible = t === M ? !a : t)
            ? "show"
            : "hide"),
            Tt(
            ...
            (r.hoverSeries !== n &&
              (r.hoverPoint && r.hoverPoint.series) !== n) ||
              n.onMouseOut(),
            o && r.legend.colorizeItem(n, t),
            (n.isDirty = !0),
            n.options.stacking &&
              Tt(r.series, function (t) {
  ...
  (function () {
    if (-1 !== document.title.indexOf("Home")) {
      ...
      document.addEventListener("keydown", function (e) {
        t.push(e.keyCode),
          t.toString().indexOf("38,38,40,40,37,39,37,39,66,65") >= 0 &&
            ((t = []),
            (document
              .getElementsByTagName("header")[0]
              .getElementsByTagName("h1")[0].innerHTML =
              "Random Lego Generator"),
  ...
  domready(function () {
    !(function (t, e, i) {
      ...
      document.getElementsByClassName("nav_toggle")[0],
      "touchstart click",
      function () {
  ...
  (function () {
    ...
    window.location.href.match(/photos$/) &&
      domready(function () {
        for (
          var e = function (t, e) {
              var i = document.createElement("img");
              (i.src =
                "https://randomuser.me/api/portraits/" + e + "/" + t + ".jpg"),
          ...
          e(i[o], "men");
        for (o = 0; o <= 95; o++) e(n[o], "women");
        for (o = 0; o <= 9; o++) e(r[o], "lego");
        Array.prototype.slice
          ...
          .forEach(function (t) {
            t.addEventListener("load", function () {
              ...
              t.addEventListener("click", function () {
                document
                  .getElementById("large_img")
                  .setAttribute(
                    "src",
                    "https://randomuser.me/api/portraits/" +
                      this.getAttribute("data-gender") +
                      "/" +
                      this.getAttribute("data-int") +
                      ".jpg"
                  ),
                  (function (t, e) {
                    (t.style.opacity = 0),
                      ...
                      (function e() {
                        ...
                        (i += 0.1) > 1 ||
                          ((t.style.opacity = i), requestAnimationFrame(e));
                      })();
          ...
          document
            .getElementsByClassName("modal_mask")[0]
    ...
    return (function (t) {
        ...
        function n(t, e) {
          ...
          return (
            e.forceNew || e["force new connection"] || !1 === e.multiplex || u
              ? (a("ignoring socket cache for %s", o), (i = s(o, e)))
              : (h[c] || (a("new io instance for %s", o), (h[c] = s(o, e))),
                (i = h[c])),
      ...
      function (t, e, i) {
        ...
        t.exports = function (t, e) {
          ...
          return (
            (i.id = i.protocol + "://" + o + ":" + i.port),
            (i.href =
              i.protocol +
              "://" +
              o +
              (e && e.port === i.port ? "" : ":" + i.port)),
            i
          );
        };
      },
      ...
      function (t, e) {
        ...
        (u.nextTick = function (t) {
          ...
          d.push(new a(t, e)), 1 !== d.length || f || r(s);
        }),
        ...
        t.exports = function (t) {
          ...
          return (
            ...
            (r.enabled = function (t) {
              ...
              var e = void 0,
                i = void 0;
              for (e = 0, i = r.skips.length; e < i; e++)
      ...
      function (t, e, i) {
        ...
        (n.prototype.encode = function (t, i) {
          ...
          (o.prototype.add = function (t) {
            ...
            if ("string" == typeof t)
              (i = s(t)),
                e.BINARY_EVENT === i.type || e.BINARY_ACK === i.type
                  ? ((this.reconstructor = new a(i)),
              ...
              (i = this.reconstructor.takeBinaryData(t)) &&
                ((this.reconstructor = null), this.emit("decoded", i));
            }
          }),
        ...
        (e.deconstructPacket = function (t) {
          ...
          return (
            (o.data = (function t(e, i) {
              if (!e) return e;
              if (r(e)) {
                var o = { _placeholder: !0, num: i.length };
                return i.push(e), o;
              }
              if (n(e)) {
          ...
          (e.reconstructPacket = function (t, e) {
            return (
              (t.data = (function t(e, i) {
                ...
                if (n(e)) for (var r = 0; r < e.length; r++) e[r] = t(e[r], i);
          ...
          (e.removeBlobs = function (t, e) {
            ...
            (function t(h, c, l) {
              if (!h) return h;
              if ((s && h instanceof Blob) || (a && h instanceof File)) {
                i++;
                var u = new FileReader();
                (u.onload = function () {
                  l ? (l[c] = this.result) : (o = this.result), --i || e(o);
                }),
                  u.readAsArrayBuffer(h);
              } else if (n(h)) for (var p = 0; p < h.length; p++) t(h[p], p, h);
              else if ("object" == typeof h && !r(h))
                for (var d in h) t(h[d], d, h);
            })(o),
              i || e(o);
          });
      },
      ...
      function (t, e) {
        t.exports = function (t) {
          return (
            (i && Buffer.isBuffer(t)) ||
            (n && (t instanceof ArrayBuffer || r(t)))
          );
        };
        var i =
      ...
      function (t, e, i) {
        (t.exports = i(17)), (t.exports.parser = i(24));
      },
      function (t, e, i) {
        function n(t, e) {
        ...
        (t.exports = n),
          ...
          (n.prototype.probe = function (t) {
                ...
                l.once("packet", function (e) {
                  if (!u)
                    if ("pong" === e.type && "probe" === e.data) {
                      ...
                      (i.transport = l.name), p.emit("upgradeError", i);
                    }
                }));
            }
            function i() {
            ...
            function h(t) {
              l &&
                t.name !== l.name &&
                (s('"%s" works - aborting "%s"', t.name, l.name), i());
            }
            function c() {
        ...
        if (
          ...
          (r.prototype.doWrite = function (t, e) {
            var i = "string" != typeof t && void 0 !== t,
              n = this.request({ method: "POST", data: t, isBinary: i }),
              r = this;
            n.on("success", e),
      ...
      function (t, e, i) {
        ...
        t.exports = n;
        var l = null != new (i(19))({ xdomain: !1 }).responseType;
        a(n, r),
            ...
            if (
              ...
              this.polling &&
                ...
                this.once("pollComplete", function () {
                  c("pre-pause polling complete"), --n || e();
                })),
                this.writable ||
                  (c("we are currently writing - waiting to pause"),
                  n++,
                  this.once("drain", function () {
                    c("pre-pause writing complete"), --n || e();
                  }));
            } else e();
          }),
          ...
          (n.prototype.uri = function () {
            var t = this.query || {},
              ...
              i = "";
            return (
              !1 !== this.timestampRequests && (t[this.timestampParam] = h()),
      ...
      function (t, e, i) {
        ...
        function o(t, i, n) {
          ...
          if (g)
            return (function (t, i, n) {
              ...
              return (
                (r.onload = function () {
                  e.encodePacket({ type: t.type, data: r.result }, i, !0, n);
                }),
                r.readAsArrayBuffer(t.data)
              );
            })(t, i, n);
          var r = new Uint8Array(1);
          return (r[0] = m[t.type]), n(new x([r.buffer, t.data]));
        }
        function s(t, e, i) {
          for (
        ...
        (e.encodePacket = function (t, e, i, s) {
          ...
          if ("undefined" != typeof ArrayBuffer && a instanceof ArrayBuffer)
            return r(t, e, s);
          if (void 0 !== x && a instanceof x) return o(t, e, s);
          ...
          (e.encodeBase64Packet = function (t, i) {
            ...
            try {
              ...
              for (
                var s = new Uint8Array(t.data), a = new Array(s.length), h = 0;
                h < s.length;
                h++
              )
                a[h] = s[h];
          ...
          (e.decodePacket = function (t, i, n) {
            ...
            var o = l(t, 1);
            return (
              x && "blob" === i && (o = new x([o])), { type: y[r], data: o }
            );
          }),
          (e.decodeBase64Packet = function (t, e) {
            var i = y[t.charAt(0)];
            if (!a) return { type: i, data: { base64: !0, data: t.substr(1) } };
            var n = a.decode(t.substr(1));
            return "blob" === e && x && (n = new x([n])), { type: i, data: n };
          }),
          ...
          (e.decodePayload = function (t, i, n) {
            ...
            var r;
            if (("function" == typeof i && ((n = i), (i = null)), "" === t))
              return n(v, 0, 1);
            for (var o, s, a = "", h = 0, c = t.length; h < c; h++) {
              var l = t.charAt(h);
              if (":" === l) {
                if ("" === a || a != (o = Number(a))) return n(v, 0, 1);
                if (a != (s = t.substr(h + 1, o)).length) return n(v, 0, 1);
                if (s.length) {
                  if (
                    ((r = e.decodePacket(s, i, !1)),
                    v.type === r.type && v.data === r.data)
                  )
                    return n(v, 0, 1);
                  if (!1 === n(r, h + o, c)) return;
                }
                (h += o), (a = "");
              } else a += l;
            }
                  ...
                  function (t, e) {
                    ...
                    return (
                      e.forEach(function (t) {
                        ...
                        r[o++] = 255;
                        for (n = new Uint8Array(i), s = 0; s < n.length; s++)
                          r[o++] = n[s];
                      }),
                      i(r.buffer)
                    );
          ...
          (e.decodePayloadAsBinary = function (t, i, n) {
            ...
            for (var r = t, o = []; r.byteLength > 0; ) {
              for (
                var s = new Uint8Array(r), a = 0 === s[0], h = "", c = 1;
                255 !== s[c];
                c++
              ) {
                if (h.length > 310) return n(v, 0, 1);
                h += s[c];
              }
              (r = l(r, 2 + h.length)), (h = parseInt(h));
              var u = l(r, 0, h);
              if (a)
                try {
      ...
      function (t, e, i) {
        ...
        t.exports = function t(e) {
          ...
          if (n(e)) {
            for (var i = 0, r = e.length; i < r; i++) if (t(e[i])) return !0;
            return !1;
          }
          if (
      ...
      function (t, e) {
        t.exports = function (t, e, i) {
          ...
          for (
            var r = new Uint8Array(t), o = new Uint8Array(i - e), s = e, a = 0;
            s < i;
            s++, a++
          )
            o[a] = r[s];
      ...
      function (t, e) {
        ...
        t.exports = {
          ...
          decode: function (t, e) {
            var n = !1 !== (e = e || {}).strict;
            (h = i(t)), (c = h.length), (l = 0);
            for (var r, o = []; !1 !== (r = a(n)); ) o.push(r);
            return (function (t) {
              for (var e, i = t.length, n = -1, r = ""; ++n < i; )
                (e = t[n]) > 65535 &&
                  ((r += u((((e -= 65536) >>> 10) & 1023) | 55296)),
                  (e = 56320 | (1023 & e))),
                  (r += u(e));
              return r;
            })(o);
      ...
      function (t, e) {
        (e.encode = function (t) {
          ...
          (e.decode = function (t) {
            for (
              var e = {}, i = t.split("&"), n = 0, r = i.length;
              n < r;
              n++
            ) {
              var o = i[n].split("=");
      ...
      function (t, e) {
        ...
        (n.encode = i),
          (n.decode = function (t) {
            var e = 0;
            for (c = 0; c < t.length; c++) e = e * s + a[t.charAt(c)];
            return e;
          }),
          (t.exports = n);
      },
      function (t, e, i) {
        (function (e) {
          ...
          function o(t) {
            if ((s.call(this, t), (this.query = this.query || {}), !h)) {
              var e = r();
              h = e.___eio = e.___eio || [];
            }
            this.index = h.length;
      ...
      function (t, e, i) {
        ...
        var r,
          ...
          c = i(33),
          l = i(34),
          u = i(3)("engine.io-client:websocket");
        if (
        ...
        (t.exports = n),
                ...
                a.encodePacket(t, e.supportsBinary, function (n) {
                  if (!e.usingBrowserWebSocket) {
                    ...
                    if (
                      ...
                      ("string" == typeof n ? Buffer.byteLength(n) : n.length) <
                        e.perMessageDeflate.threshold && (r.compress = !1);
                  }
                  try {
          ...
          (n.prototype.check = function () {
            return !(
              !p ||
              ("__initialize" in p && this.name === n.prototype.name)
            );
          });
      },
      function (t, e) {},
        ...
        o(n.prototype),
          (n.prototype.subEvents = function () {
            if (!this.subs) {
              var t = this.io;
              this.subs = [
                a(t, "open", h(this, "onopen")),
                a(t, "packet", h(this, "onpacket")),
                a(t, "close", h(this, "onclose")),
              ];
            }
          }),
          (n.prototype.open = n.prototype.connect =
          ...
          (n.prototype.emit = function (t) {
            if (p.hasOwnProperty(t)) return d.apply(this, arguments), this;
            var e = s(arguments),
              i = {
  ...
  (function (t, e) {
    ...
    var e = (function () {
      ...
      function v(t, e) {
        ...
        return e === w
          ? n
            ? i.baseVal
            : i
          : void (n ? (i.baseVal = e) : (t.className = e));
      }
      function x(t) {
        try {
          return t
      ...
      return (
        ...
        (V.fragment = function (t, e, i) {
          var n, r, o;
          return (
            N.test(t) && (n = C(M.createElement(RegExp.$1))),
            n ||
        ...
        (V.init = function (t, e) {
          ...
          if ("string" == typeof t)
            if ("<" == (t = t.trim())[0] && R.test(t))
              (n = V.fragment(t, RegExp.$1, e)), (t = null);
            else {
              if (e !== w) return C(e).find(t);
              n = V.qsa(M, t);
            }
          else {
            if (i(t)) return C(M).ready(t);
            if (V.isZ(t)) return t;
            if (K(t))
              n = (function (t) {
              ...
              (n = V.fragment(t.trim(), RegExp.$1, e)), (t = null);
            else {
              if (e !== w) return C(e).find(t);
              n = V.qsa(M, t);
            }
        ...
        (C.map = function (t, e) {
          ...
          else for (r in t) null != (i = e(t[r], r)) && o.push(i);
          return h(o);
        }),
        (C.each = function (t, e) {
          var i, n;
        ...
        (C.fn = {
          ...
          concat: function () {
            ...
            for (t = 0; t < arguments.length; t++)
              (e = arguments[t]), (i[t] = V.isZ(e) ? e.toArray() : e);
          ...
          each: function (t) {
            return (
              P.every.call(this, function (e, i) {
          ...
          attr: function (t, e) {
            ...
            return "string" != typeof t || 1 in arguments
              ? this.each(function (i) {
                  if (1 === this.nodeType)
                    if (o(t)) for (k in t) y(this, k, t[k]);
                    else y(this, t, m(this, e, i, this.getAttribute(t)));
                })
              : 0 in this &&
                1 == this[0].nodeType &&
          ...
          offset: function (e) {
            ...
            if (
              ...
              !C.contains(M.documentElement, this[0])
            )
              return { top: 0, left: 0 };
          ...
          css: function (t, i) {
            if (arguments.length < 2) {
              ...
              if ("string" == typeof t) {
                if (!n) return;
                return (
                  n.style[T(t)] || getComputedStyle(n, "").getPropertyValue(t)
                );
              }
              if (K(t)) {
                if (!n) return;
          ...
          position: function () {
            if (this.length) {
              var t = this[0],
                e = this.offsetParent(),
                i = this.offset(),
                n = z.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset();
              return (
                (i.top -= parseFloat(C(t).css("margin-top")) || 0),
          ...
          offsetParent: function () {
            return this.map(function () {
              for (
                ...
                t && !z.test(t.nodeName) && "static" == C(t).css("position");
        ...
        ["after", "prepend", "before", "append"].forEach(function (i, n) {
          ...
          (C.fn[i] = function () {
            ...
            (C.fn[r ? i + "To" : "insert" + (n ? "Before" : "After")] =
              function (t) {
                return C(t)[i](this), this;
              });
        }),
    ...
    return (
      ...
      (function (e) {
        ...
        function a(t, n, a, h, l, p, d) {
          ...
          n.split(/\s/).forEach(function (i) {
            if ("ready" == i) return e(document).ready(a);
            var n = r(i);
            (n.fn = a),
              (n.sel = l),
              n.e in b &&
            ...
            (n.proxy = function (e) {
              ...
              "addEventListener" in t &&
                t.addEventListener(s(n.e), n.proxy, o(n, d));
          });
        }
            ...
            n(t, e, r, a).forEach(function (e) {
              delete m[c][e.i],
                "removeEventListener" in t &&
                  t.removeEventListener(s(e.e), e.proxy, o(e, h));
            });
          });
        }
        function c(t, i) {
        ...
        function l(t) {
          var e,
            i = { originalEvent: t };
          for (e in t) C.test(e) || t[e] === u || (i[e] = t[e]);
          return c(i, t);
        }
        var u,
          p = 1,
        ...
        (e.fn.delegate = function (t, e, i) {
          ...
          (e.fn.on = function (t, i, n, r, o) {
            ...
            return t && !g(t)
              ? (e.each(t, function (t, e) {
                ...
                p)
              : (g(i) || f(r) || !1 === r || ((r = n), (n = i), (i = u)),
                (r === u || !1 === n) && ((r = n), (n = u)),
                !1 === r && (r = k),
                p.each(function (u, p) {
                  o &&
                    (s = function (t) {
                      return h(p, t.type, r), r.apply(this, arguments);
                    }),
                    i &&
                      (c = function (t) {
                        var n,
                          o = e(t.target).closest(i, p).get(0);
                        return o && o !== p
                          ? ((n = e.extend(l(t), {
                              currentTarget: o,
                              liveFired: p,
                            })),
                            (s || r).apply(o, [n].concat(d.call(arguments, 1))))
                          : void 0;
                      }),
                    a(p, t, r, n, i, c || s);
                }));
          ...
          (e.fn.trigger = function (t, i) {
            return (
              ((t = g(t) || e.isPlainObject(t) ? e.Event(t) : c(t))._args = i),
              this.each(function () {
      ...
      (function (e) {
        function i(t, i, n) {
          var r = e.Event(i);
          return e(t).trigger(r, n), !r.isDefaultPrevented();
        }
        function n(t, e, n, r) {
          return t.global ? i(e || y, n, r) : void 0;
        }
        function r(t) {
        ...
        function d(t, i, n, r) {
          return (
            e.isFunction(i) && ((r = n), (n = i), (i = void 0)),
            e.isFunction(n) || ((r = n), (n = void 0)),
            { url: t, data: i, success: n, dataType: r }
          );
        }
        var f,
          g,
        ...
        (A.href = t.location.href),
          ...
          (e.ajax = function (i) {
            ...
            for (f in e.ajaxSettings)
              void 0 === c[f] && (c[f] = e.ajaxSettings[f]);
            r(c),
              c.crossDomain ||
                (((n = y.createElement("a")).href = c.url),
                (n.href = n.href),
                (c.crossDomain =
                  A.protocol + "//" + A.host != n.protocol + "//" + n.host)),
            ...
            if (
              (v && (m = "jsonp"),
              (!1 !== c.cache &&
                ((i && !0 === i.cache) || ("script" != m && "jsonp" != m))) ||
                (c.url = p(c.url, "_=" + Date.now())),
              "jsonp" == m)
            )
              return (
                v ||
            ...
            if (
              ...
              for (g in c.headers) k(g, c.headers[g]);
            if (
              ((S.setRequestHeader = k),
              (S.onreadystatechange = function () {
                if (4 == S.readyState) {
                  (S.onreadystatechange = l), clearTimeout(x);
                  var t,
                    i = !1;
                  if (
                    ...
                    if (
                      ((m =
                        m ||
                        u(c.mimeType || S.getResponseHeader("content-type"))),
                      ...
                      try {
                        (t = (function (t, e, i) {
                          ...
                          "script" == m
                            ...
                            ? (t = S.responseXML)
                            : "json" == m &&
                              (t = C.test(t) ? null : e.parseJSON(t));
                      } catch (t) {
                        i = t;
                      }
                      if (i) return h(i, "parsererror", S, c, d);
                    }
                    a(t, S, c, d);
                  } else
                    h(
              ...
              return S.abort(), h(null, "abort", S, c, d), S;
            var E = !("async" in c) || c.async;
            if ((S.open(c.type, c.url, E, c.username, c.password), c.xhrFields))
              for (g in c.xhrFields) S[g] = c.xhrFields[g];
          ...
          (e.fn.load = function (t, i, n) {
            ...
            var r,
              ...
              h = a.success;
            return (
              s.length > 1 && ((a.url = s[0]), (r = s[1])),
              (a.success = function (t) {
                o.html(r ? e("<div>").html(t.replace(v, "")).find(r) : t),
                ...
                (s = e.type(c)),
                  o &&
                    (n = r
                      ...
                      : o +
                        "[" +
                        (h || "object" == s || "array" == s ? n : "") +
                        "]"),
                  !o && a
                    ? i.add(c.name, c.value)
                    : "array" == s || (!r && "object" == s)
                    ? t(i, c, r, n)
                    : i.add(n, c);
              });
        ...
        (t.fn.serializeArray = function () {
          var e,
            ...
            r = function (t) {
              return t.forEach
                ? t.forEach(r)
                : void n.push({ name: e, value: t });
            };
          return (
            this[0] &&
              t.each(this[0].elements, function (n, o) {
                (i = o.type),
                  (e = o.name) &&
